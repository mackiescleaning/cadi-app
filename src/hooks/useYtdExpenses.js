...
export const CATEGORY_TO_SA103 = {
  ...
  phone:             { box: 'Box 21', label: 'Phone, software & admin',   hmrcField: 'adminCosts' },
  subscriptions:     { box: 'Box 21', label: 'Phone, software & admin',   hmrcField: 'adminCosts' },
  ...
  bankfees:          { box: 'Box 23', label: 'Finance charges',           hmrcField: 'interest' },
  ...
  training:          { box: 'Box 27', label: 'Other allowable',           hmrcField: 'other' },
  uniform:           { box: 'Box 27', label: 'Other allowable',           hmrcField: 'other' },
