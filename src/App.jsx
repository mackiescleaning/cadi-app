...
const FmOpsExteriorWireframe = lazy(
  () => import('./pages/fm-demo/wireframe/FmOpsExteriorWireframe')
);
const FmOpsPortalWireframe = lazy(() => import('./pages/fm-demo/wireframe/FmOpsPortalWireframe'));
const CadiConnectTabWireframe = lazy(
  () => import('./pages/fm-demo/wireframe/CadiConnectTabWireframe')
);
          ...
          <ClientProvider>
            <Router>
              ...
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  <Route
                    path="/gocardless/payment-callback"
                    element={<GoCardlessPaymentCallback />}
                  />
            ...
            a clean URL distinct from the cleaning-business-owner flow. */}
                  ...
                  >
                    ...
                    <Route
                      path="invoices"
                      element={<Navigate to="/payments?tab=invoices" replace />}
                    />
