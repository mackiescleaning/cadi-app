    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.6rem' }}>
        ...
        <div style={{ textAlign: 'right' }}>
          ...
          <div style={{ fontSize: '0.48rem', color: '#aaa', marginTop: 2 }}>
      ...
      >
        <div>
          To: <em>Britannia Group</em> · 24-5-2026
        </div>
    ...
    >
      ...
      <div style={{ padding: '0.875rem 1rem', fontSize: '0.7rem' }}>
        ...
        >
          <div>
            ...
            <div style={{ fontWeight: 700, color: '#0f172a', fontSize: '0.75rem' }}>
              D. Harris Window Services
            </div>
            <div style={{ color: '#64748b', fontSize: '0.62rem', lineHeight: 1.45 }}>
              12 Maple Close, Luton LU3 2BN
            </div>
          </div>
          <div style={{ textAlign: 'right' }}>
            <div
        ...
        >
          ...
          <span style={{ color: '#0f172a', fontWeight: 700, fontSize: '0.62rem' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '0.6rem' }}>
          ...
          <tbody>
            <tr>
              <td style={{ padding: '0.42rem 0.5rem', color: '#1e293b', fontSize: '0.63rem' }}>
                {desc}
              </td>
              <td
                style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
          <div style={{ minWidth: 155 }}>
            ...
            >
              <span>Subtotal</span>
              <span style={{ fontFamily: 'monospace' }}>£85.00</span>
            </div>
            <div
              style={{
                display: 'flex',
            ...
            >
              <span>Total due</span>
              <span style={{ fontFamily: 'monospace', color: ACCENT }}>£85.00</span>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <span
                style={{
                  ...
                  fontWeight: 700,
                  whiteSpace: 'nowrap',
                  color: active ? '#fb923c' : done ? '#34d399' : 'rgba(255,255,255,0.25)',
                }}
              >
                {label}
              </span>
            ...
            {!isLast && (
              <div
                style={{
                  flex: 1,
                  height: 1,
                  background: done ? 'rgba(52,211,153,0.25)' : 'rgba(255,255,255,0.07)',
                  margin: '0 0.3rem',
                  marginBottom: '1.1rem',
                }}
              />
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontWeight: 900, fontSize: '0.95rem', color: '#34d399' }}>
          Invoice submitted
        </div>
        <div style={{ fontSize: '0.67rem', color: 'rgba(255,255,255,0.38)', lineHeight: 1.6 }}>
          Sent to{' '}
          <strong style={{ color: 'rgba(255,255,255,0.55)' }}>accounts@britanniagroup.co.uk</strong>
          <br />
      ...
      {paid ? (
        ...
        >
          ...
          >
            ...
            />
            <div style={{ flex: 1 }}>
              <div style={{ fontWeight: 900, fontSize: '0.72rem', color: '#34d399' }}>
                Payment approved by Britannia Group
              </div>
              <div style={{ fontSize: '0.58rem', color: 'rgba(255,255,255,0.3)', marginTop: 1 }}>
                Approved by James Harper · Area Manager · just now
              </div>
            </div>
          </div>
          <div
          ...
          >
            {[
              ...
              >
                <span
                  style={{ fontSize: '0.63rem', color: 'rgba(255,255,255,0.32)', fontWeight: 600 }}
                >
                  {label}
                </span>
                <span
                  style={{
                    fontSize: highlight ? '0.88rem' : '0.68rem',
                    fontWeight: highlight ? 900 : 700,
                    color: highlight ? '#34d399' : 'rgba(255,255,255,0.72)',
                  }}
                >
                  {value}
                </span>
          ...
          >
            Your bank will receive this via BACS. Typical clearing time: 1–2 business days after pay
            date.
          </div>
        </div>
      ) : (
  ...
  return (
    ...
    >
      <div style={{ marginBottom: '0.1rem' }}>
        ...
        >
          Submit invoice — BF-4471
        </div>
        <div style={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.25)', lineHeight: 1.5 }}>
          Choose how you want to submit your invoice for this job.
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.38)', lineHeight: 1.45 }}>
              Pre-filled from your job card. Reviewed and submitted in under a minute.
            </div>
          </div>
      ...
      <button
        ...
        onMouseLeave={(e) => {
          e.currentTarget.style.border = '1px solid rgba(52,211,153,0.22)';
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              <span style={{ fontWeight: 900, fontSize: '0.82rem', color: 'white' }}>
                Upload paper invoice
              </span>
              <span
                style={{
            ...
            <div style={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.38)', lineHeight: 1.45 }}>
              Already written your invoice? Photo it — Cadi reads it automatically.
            </div>
          </div>
...
function CreateInvoiceFlow({ onReset }) {
  ...
  if (step === 'submitted')
    return (
      <SubmittedPanel paid={paid} onReset={onReset} invNo={invNo.replace(/\D/g, '') || '047'} />
    );
    ...
    <div style={{ padding: '1.25rem 1rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      {step === 'form' && (
        ...
        >
          ...
          >
            <span style={{ fontSize: '0.57rem', color: 'rgba(255,255,255,0.27)', fontWeight: 600 }}>
              From (your profile)
            </span>
            <span style={{ fontSize: '0.63rem', fontWeight: 700, color: 'rgba(255,255,255,0.45)' }}>
              D. Harris Window Services
            </span>
          </div>
      ...
      {step === 'generating' && (
        ...
        >
          ...
          <div style={{ fontSize: '0.7rem', fontWeight: 700, color: 'rgba(255,255,255,0.4)' }}>
            Generating your Britannia invoice…
          </div>
        </div>
      )}
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: '#34d399' }}>
            ...
            <span style={{ fontSize: '0.7rem', fontWeight: 800 }}>
              Invoice ready — review before submitting
            </span>
          </div>
...
function PaperInvoiceFlow({ onReset }) {
  ...
  useEffect(() => {
    ...
    const timers = READING_LINES.map((l, i) =>
    ...
    <div style={{ padding: '1.25rem 1rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      {step === 'upload' && (
        ...
        >
          ...
          >
            Photo or scan your handwritten invoice — Cadi reads it and generates a
            Britannia-approved PDF automatically
          </div>
          <PaperInvoiceMock />
          <button
            onClick={() => {
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.3rem' }}>
            {READING_LINES.map((line, i) => (
              ...
              >
                <span style={{ fontSize: '0.63rem', color: 'rgba(255,255,255,0.38)' }}>
                  {line.label}
                </span>
                <span
                  style={{
                    fontSize: '0.67rem',
                    fontWeight: 700,
                    color: visible.includes(i) ? '#34d399' : 'rgba(255,255,255,0.2)',
                  }}
                >
      ...
      {step === 'preview' && (
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: '#34d399' }}>
            <CheckCircle2 size={14} />
            <span style={{ fontSize: '0.7rem', fontWeight: 800 }}>
              All fields extracted — Britannia PDF ready
            </span>
          </div>
          <BritanniaPDFPreview />
          <button
...
// ── Evidence Tab ──────────────────────────────────────────────────────────────
function EvidenceTab({ done: _done, onDone }) {
  ...
  return (
    <div
      style={{ padding: '1.25rem 1rem', display: 'flex', flexDirection: 'column', gap: '0.85rem' }}
    >
        ...
        {photos.map((up, i) => (
          <button
            ...
            style={{
              aspectRatio: '1',
              borderRadius: '0.75rem',
              border: up ? '1px solid rgba(52,211,153,0.35)' : '1px dashed rgba(255,255,255,0.15)',
              background: up ? 'rgba(52,211,153,0.07)' : 'rgba(255,255,255,0.03)',
              display: 'flex',
              flexDirection: 'column',
              alignItems: 'center',
              justifyContent: 'center',
          ...
          >
            {up ? (
              <>
                <CheckCircle2 size={20} color="#34d399" />
                <span style={{ fontSize: '0.55rem', color: '#34d399', fontWeight: 700 }}>
                  Uploaded
                </span>
              </>
            ) : (
              <>
                ...
                <span
                  style={{ fontSize: '0.55rem', color: 'rgba(255,255,255,0.28)', fontWeight: 600 }}
                >
                  Add photo
                </span>
              </>
      ...
      >
        ...
        <div>
          <div style={{ fontSize: '0.68rem', fontWeight: 700, color: 'rgba(255,255,255,0.65)' }}>
            Premier Inn Luton Airport
          </div>
          <div style={{ fontSize: '0.57rem', color: 'rgba(255,255,255,0.25)', marginTop: 1 }}>
            51.8762° N, 0.3624° W · 08:04 today
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: '0.68rem', color: 'rgba(255,255,255,0.42)' }}>
          Completed at <strong style={{ color: 'rgba(255,255,255,0.62)' }}>08:04</strong> · 2 hrs 4
          mins on site
        </div>
      </div>
      ...
      {!submitted ? (
        <button
          ...
          style={{
            ...
            color: allUploaded ? 'white' : 'rgba(255,255,255,0.25)',
            fontWeight: 800,
            fontSize: '0.8rem',
            cursor: allUploaded ? 'pointer' : 'not-allowed',
            boxShadow: allUploaded ? '0 4px 16px rgba(234,88,12,0.3)' : 'none',
            transition: 'all 0.2s',
          }}
        >
          {allUploaded
            ? 'Submit evidence & proceed to invoice →'
            : `Upload ${photos.filter(Boolean).length}/3 photos to continue`}
        </button>
      ) : (
        <div
          style={{
        ...
        >
          ...
          <span style={{ fontSize: '0.72rem', fontWeight: 700 }}>
            Evidence submitted — opening Invoice tab…
          </span>
        </div>
      )}
    </div>
...
function JobCardTab({ done, onDone }) {
  return (
    <div
      style={{ padding: '1.25rem 1rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}
    >
      <div
        style={{
          display: 'inline-flex',
      ...
      <div>
        ...
        <div style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.42)', marginTop: '0.2rem' }}>
          {JOB.site}
        </div>
      </div>
      ...
      {[
        ...
        >
          ...
          <div>
            <div style={{ fontSize: '0.7rem', fontWeight: 700, color: 'rgba(255,255,255,0.68)' }}>
              {value}
            </div>
            <div style={{ fontSize: '0.57rem', color: 'rgba(255,255,255,0.25)', marginTop: 1 }}>
              {sub}
      ...
      {!done ? (
        ...
        >
          <CheckCircle2 size={15} />
          <span style={{ fontSize: '0.72rem', fontWeight: 700 }}>
            Job complete — upload your evidence next
          </span>
        </div>
      )}
    </div>
...
function WelcomeTab({ onStart, onActivate }) {
  ...
  useEffect(() => {
    const t = setTimeout(() => setSmsIn(true), 380);
    return () => clearTimeout(t);
  }, []);
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          opacity: smsIn ? 1 : 0,
          transform: smsIn ? 'translateY(0)' : 'translateY(8px)',
      ...
      >
        ...
        <div>
          ...
          >
            SMS from Britannia Group · just now
          </div>
          <div style={{ fontSize: '0.68rem', color: 'rgba(255,255,255,0.75)', lineHeight: 1.55 }}>
            Hi Dave — Britannia Group has added you to their contractor network on Cadi. Your free
            account is ready.
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <div>
            <div style={{ fontWeight: 900, fontSize: '0.8rem', color: 'white' }}>
              Cadi Lite — your free account is live
            </div>
            <div style={{ fontSize: '0.56rem', color: 'rgba(255,255,255,0.35)', marginTop: 1 }}>
              Set up by Britannia Group · free for you, forever
            </div>
          </div>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
          {[
            ...
            >
              ...
              <div
                style={{ fontSize: '0.63rem', fontWeight: 800, color: 'rgba(255,255,255,0.72)' }}
              >
                {label}
              </div>
              <div
          ...
          {[
            {
              n: '1',
              label: 'Job comes in',
              detail: 'Britannia sends you a job via Cadi Connect — you accept or decline in-app',
            },
            {
              n: '2',
              label: 'View your job card',
              detail: 'Site address, time slot, rate, and FM contact — all in one place',
            },
            {
              n: '3',
              label: 'Upload evidence',
              detail: 'Photograph the completed work directly in the app to confirm delivery',
            },
            {
              n: '4',
              label: 'Invoice & get paid',
              detail:
                'Invoice pre-fills from your job card — submit in seconds, track payment in-app',
            },
          ].map(({ n, label, detail }) => (
            <div key={n} style={{ display: 'flex', gap: '0.65rem', alignItems: 'flex-start' }}>
              ...
              <div>
                <div
                  style={{ fontSize: '0.67rem', fontWeight: 800, color: 'rgba(255,255,255,0.68)' }}
                >
                  {label}
                </div>
                <div
      ...
      >
        ...
        />
        <span style={{ fontSize: '0.62rem', color: 'rgba(255,255,255,0.45)', fontWeight: 600 }}>
          You already have a new job waiting
        </span>
      </div>
...
function NewJobTab({ onAccept, onDecline, declined }) {
  return (
    <div
      style={{ padding: '1.25rem 1rem', display: 'flex', flexDirection: 'column', gap: '0.9rem' }}
    >
      {/* Notification header */}
      <div
        style={{
      ...
      >
        ...
        />
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: '0.72rem', fontWeight: 900, color: '#fb923c' }}>
            New job offered via Cadi Connect
          </div>
          <div style={{ fontSize: '0.58rem', color: 'rgba(255,255,255,0.38)', marginTop: 1 }}>
            Sent by James Harper · Area Manager · 2 min ago
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          >
            <div>
              <div style={{ fontWeight: 900, fontSize: '1rem', color: 'white', lineHeight: 1.15 }}>
                {JOB.task}
              </div>
              <div
                style={{
            ...
            <div style={{ fontWeight: 900, fontSize: '1.1rem', color: '#fb923c', flexShrink: 0 }}>
              {JOB.rate}
            </div>
          </div>
        </div>
        ...
        >
          {[
            ...
            >
              ...
              <div
                style={{ fontSize: '0.68rem', fontWeight: 700, color: 'rgba(255,255,255,0.72)' }}
              >
                {value}
              </div>
            </div>
      ...
      >
        ...
        <span style={{ fontSize: '0.62rem', color: 'rgba(255,255,255,0.38)', lineHeight: 1.4 }}>
          You were selected because your Connect score of{' '}
          <strong style={{ color: '#fb923c' }}>91</strong> is the highest match for this job type
          and location.
        </span>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
        ...
        <span style={{ fontSize: '0.62rem', color: '#fbbf24', fontWeight: 700 }}>
          Respond within 2 hours or job will be offered to the next available sub
        </span>
      </div>
      ...
      {!declined ? (
        ...
        >
          ...
          <div style={{ fontSize: '0.63rem', color: 'rgba(255,255,255,0.3)', lineHeight: 1.5 }}>
            Britannia Group has been notified. Job re-dispatched to next available contractor
            automatically.
          </div>
        </div>
      )}
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: '0.67rem', color: 'rgba(255,255,255,0.38)', lineHeight: 1.6 }}>
            Your quote of <strong style={{ color: '#fb923c' }}>£{amount}</strong> sent to
            <br />
            <strong style={{ color: 'rgba(255,255,255,0.55)' }}>
              James Harper · Britannia Group
            </strong>
          </div>
        </div>
        ...
        {approved ? (
          ...
          >
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontWeight: 900, fontSize: '0.72rem', color: '#34d399' }}>
                  Quote approved by Britannia Group
                </div>
                <div style={{ fontSize: '0.58rem', color: 'rgba(255,255,255,0.3)', marginTop: 1 }}>
                  James Harper · Area Manager · just now
                </div>
              </div>
            </div>
            <div
            ...
            >
              Job is now confirmed. You'll receive a job card with full site details before the
              date.
            </div>
          </div>
        ) : (
          ...
          >
            ...
            />
            <span style={{ fontSize: '0.65rem', color: 'rgba(255,255,255,0.3)', fontWeight: 600 }}>
              Waiting for FM to review your quote…
            </span>
          </div>
        )}
      </div>
  ...
  if (step === 'quote') {
    return (
      ...
      >
        ...
        <div style={{ fontWeight: 800, fontSize: '0.78rem', color: 'rgba(255,255,255,0.6)' }}>
          Submit your quote — {QUOTE_JOB.ref}
        </div>
        ...
        <button
          ...
          style={{
            ...
            background: amount
              ? `linear-gradient(135deg, ${ACCENT}, #c2410c)`
              : 'rgba(255,255,255,0.04)',
            border: amount ? 'none' : '1px solid rgba(255,255,255,0.08)',
            color: amount ? 'white' : 'rgba(255,255,255,0.25)',
            fontWeight: 800,
            fontSize: '0.8rem',
            ...
            justifyContent: 'center',
            gap: '0.45rem',
            boxShadow: amount ? '0 4px 16px rgba(234,88,12,0.35)' : 'none',
            transition: 'all 0.2s',
          }}
        >
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Quote Requested · Britannia Group
        </span>
      </div>
      ...
      >
        <span style={{ fontSize: '0.68rem', color: 'rgba(255,255,255,0.42)' }}>Job rate</span>
        <span style={{ fontWeight: 900, fontSize: '0.88rem', color: '#a78bfa' }}>
          Your price — submit quote
        </span>
      </div>
...
function CadiLiteDashboard() {
    ...
    return (
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <div style={{ fontWeight: 900, fontSize: '0.8rem', color: '#010a4f' }}>
              Good morning, Dave 👋
            </div>
            <div style={{ fontSize: '0.53rem', color: '#64748b', marginTop: 1 }}>
              Wed 27 May 2026 · Week 22
            </div>
          </div>
          <div
            style={{
        ...
        <div
          style={{
            ...
            display: 'flex',
            gap: '0.875rem',
            boxShadow: '0 4px 20px rgba(1,10,79,0.3)',
          }}
        >
          ...
          >
            ...
            >
              <span
                style={{ fontSize: '0.55rem', fontWeight: 900, color: 'rgba(255,255,255,0.7)' }}
              >
                Score breakdown
              </span>
              <span
                ...
                <div style={{ height: 3, borderRadius: 2, background: 'rgba(255,255,255,0.08)' }}>
                  <div
                    style={{
                      ...
                      height: '100%',
                      borderRadius: 2,
                      background: 'linear-gradient(90deg, #4f78ff, #34d399)',
                    }}
                  />
                </div>
              </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '0.4rem' }}>
          {[
            ...
            >
              <div style={{ fontWeight: 900, fontSize: '0.75rem', color, lineHeight: 1 }}>
                {value}
              </div>
              <div
                style={{
              ...
              <div style={{ fontSize: '0.44rem', color: '#94a3b8', marginTop: '0.1rem' }}>
                {sub}
              </div>
            </div>
          ))}
          ...
          {LB.map(({ name, rank, s, me }) => (
            <div
              ...
              style={{
                ...
                gap: '0.5rem',
                padding: '0.42rem 0.75rem',
                borderBottom: rank < 5 ? '1px solid #f1f5f9' : 'none',
                background: me ? '#f0f4ff' : 'transparent',
              }}
            >
              <span
                style={{
  ...
  function MarketplaceView() {
    const OFFERS = [
      ...
      {
        ref: 'AP-3341',
        site: 'Tesco Extra Manchester',
        client: 'Apex Property Mgmt',
        date: 'Fri 30 May',
        time: '06:30–08:30',
        rate: '£95',
        match: 88,
    ...
    return (
      <div
        style={{ padding: '0.875rem', display: 'flex', flexDirection: 'column', gap: '0.65rem' }}
      >
        <div>
          <div style={{ fontWeight: 900, fontSize: '0.8rem', color: '#010a4f' }}>
            Cadi Connect Marketplace
          </div>
          <div style={{ fontSize: '0.55rem', color: '#64748b', marginTop: 2 }}>
            Jobs matched to your trade, location and Connect score
          </div>
        </div>
        {OFFERS.map(({ ref, site, client, date, time, rate, match }) => (
          ...
          >
            ...
            >
              <div>
                <div style={{ fontWeight: 800, fontSize: '0.68rem', color: '#0f172a' }}>
                  Window cleaning — exterior
                </div>
                <div style={{ fontSize: '0.55rem', color: '#64748b', marginTop: 2 }}>{site}</div>
                <div style={{ fontSize: '0.5rem', color: '#94a3b8', marginTop: 1 }}>
                  {client} · {ref}
                </div>
              </div>
              <div style={{ textAlign: 'right', flexShrink: 0 }}>
                ...
                <div
                  style={{ fontSize: '0.5rem', fontWeight: 800, color: '#059669', marginTop: 2 }}
                >
                  {match}% match
                </div>
              </div>
      ...
      >
        ...
        {JOBS.map(({ ref, site, client, date, time, rate, status }) => (
          <div
            ...
            style={{
              borderRadius: '0.875rem',
              border: `1px solid ${status === 'active' ? '#fed7aa' : '#e2e8f0'}`,
              background: status === 'active' ? '#fff7ed' : 'white',
          ...
          >
            ...
            >
              ...
              <span style={{ fontWeight: 900, fontSize: '0.82rem', color: ACCENT, flexShrink: 0 }}>
                {rate}
              </span>
            </div>
            <div
            ...
            >
              <span
                style={{
                  ...
                  borderRadius: 999,
                  background: status === 'active' ? '#fff7ed' : '#f1f5f9',
                  border: `1px solid ${status === 'active' ? '#fed7aa' : '#e2e8f0'}`,
                  color: status === 'active' ? ACCENT : '#64748b',
                  fontWeight: 700,
                }}
              >
            ...
            >
              <div
                style={{
                  ...
                  height: 26,
                  borderRadius: '0.45rem',
                  background: status === 'paid' ? 'rgba(52,211,153,0.1)' : 'rgba(234,88,12,0.1)',
                  border: `1px solid ${status === 'paid' ? 'rgba(52,211,153,0.25)' : 'rgba(234,88,12,0.25)'}`,
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  flexShrink: 0,
              ...
              <div style={{ textAlign: 'right' }}>
                <div
                  style={{
                    fontWeight: 900,
                    fontSize: '0.68rem',
                    color: status === 'paid' ? '#059669' : ACCENT,
                  }}
                >
                  {amount}
                </div>
                <div
                  style={{
                    fontSize: '0.48rem',
                    fontWeight: 700,
                    color: status === 'paid' ? '#059669' : '#f59e0b',
                    textTransform: 'uppercase',
                    marginTop: 1,
                  }}
                >
      ...
      >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.4rem' }}>
          {[
            ...
            >
              <div style={{ fontWeight: 900, fontSize: '0.88rem', color, lineHeight: 1 }}>
                {value}
              </div>
              <div
                style={{
              ...
              <div style={{ fontSize: '0.47rem', color: '#94a3b8', marginTop: '0.1rem' }}>
                {sub}
              </div>
            </div>
          ))}
            ...
            {MONTHS.map(({ m, v }) => (
              ...
              >
                <div
                  style={{
                    width: '100%',
                    borderRadius: '0.22rem 0.22rem 0 0',
                    background: v > 0 ? (m === 'May' ? ACCENT : '#c7d2fe') : 'transparent',
                    height: `${(v / max) * 52}px`,
                  }}
                />
        ...
        >
          ...
          {[
            ...
            <div key={name} style={{ marginBottom: '0.38rem' }}>
              ...
              >
                <span style={{ fontSize: '0.56rem', color: '#475569', fontWeight: 600 }}>
                  {name}
                </span>
                <span style={{ fontSize: '0.56rem', color: '#0f172a', fontWeight: 800 }}>
                  {amount}
                </span>
              </div>
    ...
    return (
      ...
      >
        ...
        <div style={{ borderRadius: '0.875rem', overflow: 'hidden', border: '1px solid #e2e8f0' }}>
          <div
            style={{
              background: 'linear-gradient(135deg, #010a4f, #0d1e78)',
              padding: '0.875rem',
              display: 'flex',
              gap: '0.65rem',
              alignItems: 'center',
          ...
          >
            ...
            <div>
              <div style={{ fontWeight: 900, fontSize: '0.78rem', color: 'white' }}>
                D. Harris Window Services
              </div>
              <div style={{ fontSize: '0.55rem', color: 'rgba(255,255,255,0.5)', marginTop: 2 }}>
                Window Cleaning · Exterior · Luton & Surrounding
              </div>
              <div style={{ display: 'flex', gap: '0.3rem', marginTop: '0.3rem' }}>
                <span
                  style={{
                    ...
                    padding: '0.1rem 0.42rem',
                    borderRadius: 999,
                    background: 'rgba(79,120,255,0.25)',
                    color: '#99c5ff',
                  }}
                >
                  Elite ★
          ...
          {[
            {
              client: 'Britannia Group',
              stars: 5,
              text: 'Excellent work as always. Arrived early, thorough finish.',
              date: 'Mon 25 May',
            },
            {
              client: 'Summit Facilities',
              stars: 5,
              text: 'Always reliable. Would highly recommend to other FMs.',
              date: 'Wed 20 May',
            },
            ...
            >
              ...
              >
                <span style={{ fontSize: '0.58rem', fontWeight: 800, color: '#0f172a' }}>
                  {client}
                </span>
              ...
              <div style={{ fontSize: '0.48rem', color: '#94a3b8', marginTop: '0.18rem' }}>
                {date}
              </div>
            </div>
          ))}
  ...
  function FrontDeskView() {
    const AGENTS = [
      {
        name: 'Sales Manager',
        role: 'Handles inbound enquiries, quotes & bookings',
        color: '#3b5bdb',
        icon: '📩',
        actions: 3,
        pro: false,
      ...
      {
        name: 'Review Agent',
        role: 'Sends review requests after every completed job',
        color: '#059669',
        icon: '⭐',
        actions: 1,
        pro: false,
      },
      {
        ...
        role: 'Reminders, schedules, check-ins, payment match',
        color: '#C2410C',
        icon: '⚙️',
        actions: 0,
        pro: true,
    ...
    return (
      ...
      >
        <div>
          ...
          <div style={{ fontSize: '0.55rem', color: '#64748b', marginTop: 2 }}>
            Your AI staff — working for you 24/7
          </div>
        </div>
        {AGENTS.map(({ name, role, color, icon, actions, pro }) => (
          <div
            ...
            style={{
              borderRadius: '0.875rem',
              border: `1px solid ${pro ? '#e2e8f0' : color + '33'}`,
              background: pro ? '#fafafa' : 'white',
              padding: '0.65rem 0.75rem',
              opacity: pro ? 0.7 : 1,
            }}
          >
            <div style={{ display: 'flex', gap: '0.55rem', alignItems: 'flex-start' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  <span style={{ fontWeight: 800, fontSize: '0.65rem', color: '#0f172a' }}>
                    {name}
                  </span>
                  {pro ? (
                    <span
                ...
                <div style={{ fontSize: '0.54rem', color: '#64748b', lineHeight: 1.45 }}>
                  {role}
                </div>
              </div>
            </div>
    ...
    return (
      ...
      >
        <div>
          ...
          <div style={{ fontSize: '0.55rem', color: '#64748b', marginTop: 2 }}>
            Schedule, customers, payments, staff and more
          </div>
        </div>
        <div
          style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.4rem' }}>
          {FEATURES.map(({ label, sub, icon }) => (
            ...
            >
              ...
              <div style={{ fontSize: '0.47rem', color: '#94a3b8', marginTop: '0.08rem' }}>
                {sub}
              </div>
            </div>
          ))}
    ...
    return (
      ...
      >
        <div>
          ...
          <div style={{ fontSize: '0.55rem', color: '#64748b', marginTop: 2 }}>
            AI-powered tools to grow your cleaning business
          </div>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            Growth strategies, pricing analysis and AI insights tailored to your trade and location
          </div>
      ...
      >
        ...
        <div style={{ borderRadius: '0.875rem', overflow: 'hidden', border: '1px solid #e2e8f0' }}>
          ...
          >
            ...
            <div>
              <div style={{ fontWeight: 900, fontSize: '0.68rem', color: 'white' }}>
                Dave Harris
              </div>
          ...
          {[
            ...
            >
              ...
              <span style={{ fontSize: '0.58rem', color: '#0f172a', fontWeight: 700 }}>
                {value}
              </span>
            </div>
          ))}
        ...
        >
          ...
          >
            Unlock Run + Grow + Front Desk — the full Business OS for cleaners
          </div>
          <button
            style={{
        ...
        <nav style={{ flex: 1, padding: '0.55rem 0.45rem', overflowY: 'auto' }}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '0.6rem',
              background: activeTab === 'dashboard' ? '#1f48ff' : 'transparent',
              border: 'none',
              cursor: 'pointer',
              marginBottom: '0.3rem',
            }}
          >
            <LayoutDashboard
              size={12}
              color={activeTab === 'dashboard' ? 'white' : 'rgba(153,197,255,0.65)'}
            />
            <span
              style={{
                fontSize: '0.62rem',
          ...
          <div
            style={{ height: 1, background: 'rgba(255,255,255,0.1)', margin: '0.1rem 0 0.3rem' }}
          />

          {SIDEBAR_SECTIONS.map(
            ({ id: secId, tagline, subLabel, accent, badge, items, viewKey: sectionViewKey }) => (
              <div key={secId} style={{ marginBottom: '0.18rem' }}>
                ...
                >
                  ...
                  <ChevronRight
                    size={8}
                    color="rgba(153,197,255,0.3)"
                    style={{
                      transform: expanded[secId] ? 'rotate(90deg)' : 'rotate(0deg)',
                        ...
                        <button
                          ...
                          style={{
                            ...
                            background: isActive
                              ...
                              : 'transparent',
                            border: isActive
                              ? `1px solid ${isConnect ? 'rgba(194,65,12,0.28)' : 'rgba(255,255,255,0.12)'}`
                          ...
                          <Icon
                            ...
                            color={
                              isActive
                                ? isConnect
                                  ? '#fb923c'
                                  : 'rgba(153,197,255,0.9)'
                                : 'rgba(153,197,255,0.42)'
                            }
                          />
                          <span
                            style={{
        ...
        <div style={{ padding: '0.55rem 0.6rem', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: '0.44rem', color: 'rgba(153,197,255,0.45)' }}>
                Cadi Lite · Free
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div
          style={{
            ...
            borderBottom: '1px solid rgba(153,197,255,0.28)',
            padding: '0.55rem 0.875rem',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'space-between',
        ...
        >
          <span style={{ fontWeight: 900, fontSize: '0.68rem', color: '#010a4f' }}>
            {ITEM_LABELS[activeItemId] || 'Dashboard'}
          </span>
          <span
            style={{
              fontSize: '0.5rem',
  ...
  const phoneCard = (
    ...
    >
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <div style={{ fontWeight: 900, fontSize: '0.88rem', color: 'white', lineHeight: 1 }}>
              Dave Harris
            </div>
            <div style={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.32)', marginTop: 2 }}>
              Contractor · Connect score 91
            </div>
          </div>
              ...
              <button
                onClick={() =>
                  (s.done ||
                    tab === s.id ||
                    (s.id === 'job' && accepted) ||
                    (s.id === 'evidence' && jobDone) ||
                    (s.id === 'invoice' && evidenceDone)) &&
                  setTab(s.id)
                }
                style={{
                  display: 'flex',
                  ...
                  borderRadius: '0.4rem',
                  background: tab === s.id ? ACCENT_DIM : 'transparent',
                  border: 'none',
                  cursor: 'pointer',
                }}
              >
                <div
                  style={{
                    ...
                    fontSize: '0.5rem',
                    fontWeight: 900,
                    color: s.done ? '#34d399' : tab === s.id ? '#fb923c' : 'rgba(255,255,255,0.25)',
                  }}
                >
                  {s.done ? '✓' : i + 1}
                </div>
                <span
                  style={{
                    fontSize: '0.6rem',
                    fontWeight: 700,
                    color: tab === s.id ? '#fb923c' : s.done ? '#34d399' : 'rgba(255,255,255,0.28)',
                    whiteSpace: 'nowrap',
                  }}
                >
                  {s.label}
              ...
              {i < JOURNEY.length - 1 && (
                <div
                  style={{
                    flex: 1,
                    height: 1,
                    background: s.done ? 'rgba(52,211,153,0.2)' : 'rgba(255,255,255,0.06)',
                    margin: '0 0.2rem',
                  }}
                />
              )}
      ...
      <div style={{ minHeight: 520 }}>
        {activating && (
          ...
          >
            ...
            >
              Setting up your Cadi Lite account…
            </div>
        ...
        {!activating && !showWelcome && tab === 'job' && (
          <JobCardTab
            ...
            onDone={() => {
              setJobDone(true);
              setTimeout(() => setTab('evidence'), 400);
            }}
          />
        )}
  ...
  return (
    <div
      style={{
        ...
        padding: activated ? '2rem 1.5rem 5rem' : '2.5rem 1rem 5rem',
    ...
    >
      ...
      >
        <div style={{ padding: '0.875rem 1.1rem' }}>
          ...
          >
            ...
            >
              Contractor Portal · Exterior Works
            </span>
          </div>
          <p
            style={{
          ...
          >
            This is what{' '}
            <strong style={{ color: 'rgba(255,255,255,0.7)' }}>Dave Harris Window Services</strong>{' '}
            sees on their phone when Britannia sends them an exterior job. Employed staff use the{' '}
            <a
              href="/staff-demo"
      ...
      {activated ? (
        ...
        <div style={{ width: '100%', maxWidth: 400 }}>{phoneCard}</div>
      )}
    </div>
  );
}
