...
const DEMO_STAFF = [
  {
    ...
    training: {
      ...
      weeks: [
        ...
        {
          id: 4,
          title: 'Week 4 — Review & sign-off',
          status: 'not-started',
          tasks: ['30-day review', 'Quality audit', 'Confirm schedule', 'Set 90-day goals'],
        },
      ],
      taskCompletions: {
        '1-0': true,
  ...
  },
  {
    ...
    training: {
      ...
      weeks: [
        {
          id: 1,
          title: 'Week 1 — Leadership foundations',
          status: 'complete',
          tasks: [
            'Role expectations',
            'Team communication',
        ...
        {
          id: 2,
          title: 'Week 2 — Client relationships',
          status: 'complete',
          tasks: ['Client retention', 'Complaint handling', 'Upsell opportunities', 'Reporting'],
        },
        {
          id: 3,
          title: 'Week 3 — Team management',
          status: 'complete',
          tasks: [
            'Briefing staff',
        ...
        {
          id: 4,
          title: 'Week 4 — Operations',
          status: 'complete',
          tasks: ['Scheduling', 'Invoicing overview', 'Supply management', 'KPI tracking'],
        },
        {
          id: 5,
          title: 'Week 5 — Review & autonomy',
          status: 'complete',
          tasks: ['60-day review', 'Solo accountability', 'Handover process', '90-day goals'],
        },
      ],
      taskCompletions: {},
      notes: {},
...
const TRAINING_TEMPLATES = {
    ...
    weeks: [
      {
        title: 'Week 1 — Standards & safety',
        tasks: [
          'COSHH chemical awareness & safe handling',
          'Correct product dilution ratios',
      ...
      },
      {
        title: 'Week 2 — Shadow on jobs',
        tasks: [
          '3 accompanied jobs with senior cleaner',
          'Room-by-room cleaning checklist walkthrough',
          'Time management on site',
          'Dealing with client requests politely',
          'How to handle a complaint on-site',
        ],
      },
      {
        title: 'Week 3 — Solo supervised',
        tasks: [
          'First solo jobs with check-in call',
          'Quality self-check before leaving',
          'Post-job client follow-up process',
          'Problem escalation — who to call and when',
          'Logging jobs in the app',
        ],
      },
      {
        title: 'Week 4 — Review & sign-off',
        tasks: [
          '30-day review conversation with manager',
          'Quality audit of one full job',
          'Confirm ongoing schedule and route',
          'Set 90-day personal goals',
          'Introduction to pay and holiday process',
        ],
      },
    ],
  },
    ...
    weeks: [
      {
        title: 'Week 1 — Leadership foundations',
        tasks: [
          'Role expectations and scope of authority',
          'Team communication standards',
          'Understanding the weekly schedule',
          'Quality standards and what to inspect',
          'Escalation process',
        ],
      },
      {
        ...
        tasks: [
          ...
          'Handling complaints at team lead level',
          'Spotting upsell opportunities ethically',
          'Client visit reporting and sign-off',
        ],
      },
      {
        title: 'Week 3 — Team management',
        tasks: [
          'How to brief staff before a job',
          'Monitoring performance without micromanaging',
          'Conflict resolution — scripts and approach',
          'Planning coverage for absences',
        ],
      },
      {
        title: 'Week 4 — Operations',
        tasks: [
          ...
          'Understanding invoicing and pricing',
          'Supply ordering and stock control',
      ...
      },
      {
        ...
        tasks: [
          ...
          'Solo decision-making accountability',
          "Handover process when you're off",
          'Setting team 90-day goals',
        ],
      },
    ],
  },
  commercial: {
    ...
    weeks: [
      {
        title: 'Week 1 — Commercial standards',
        tasks: [
          'BICS standards overview',
          'Commercial vs residential differences',
          'Site induction requirements',
          'COSHH for commercial chemicals',
          'PPE for commercial environments',
          'Lone working safety protocols',
        ],
      },
      {
        title: 'Week 2 — Site procedures',
        tasks: [
          'Access and security — keys, fobs, alarms',
          'Out-of-hours working procedures',
          'Commercial client communication',
          'Signing in and out of sites',
          'Completion sheets and sign-off documents',
        ],
      },
      {
        title: 'Week 3 — Specialist tasks',
        tasks: [
          'Hard floor care and machinery',
          'Carpet extraction equipment',
          'Washroom hygiene standards',
          'Waste segregation',
          'Consumables restocking process',
        ],
      },
      {
        title: 'Week 4 — Contract management',
        tasks: [
          'Understanding SLA requirements',
          'Audit preparation',
          'Reporting maintenance issues',
          'Quality checks and photo evidence',
  ...
  exterior: {
    ...
    weeks: [
      {
        title: 'Week 1 — Equipment & safety',
        tasks: [
          'Water-fed pole setup and maintenance',
          'Ladder safety and hierarchy regulations',
          'Working at height risk assessment',
          'PASMA awareness (if scaffold needed)',
          'Equipment daily checks and sign-off',
        ],
      },
      {
        title: 'Week 2 — Technique & standards',
        tasks: [
          'Pure water window cleaning technique',
          'Streak-free quality standard',
          'Gutter vacuum system operation',
          'Pressure washer settings by surface',
          'Post-job quality check process',
        ],
      },
      {
        title: 'Week 3 — Rounds & routing',
        tasks: [
          'Understanding window round cycles (6/8/12 weeks)',
          'Efficient routing and time management',
          'Client access — key safe protocols',
          'Reporting damage or issues found',
          'Upsell scripts — gutters, fascias, driveways',
        ],
      },
    ],
  },
  ...
  cleaner: [
    {
      ...
      q: 'Tell me about a time you had to manage your own schedule without supervision. How did you make sure everything got done?',
      why: 'Cleaning is mostly unsupervised. You need to know they can self-manage.',
      maxScore: 5,
    },
    {
      category: 'Attitude',
      q: 'What does a clean property mean to you? How do you know when a job is done properly?',
      why: 'Reveals standards and pride in their work. Vague answers suggest low standards.',
      maxScore: 5,
    },
    {
      category: 'Client-facing',
      q: "If a client came home while you were cleaning and said they weren't happy with something, what would you do?",
      why: 'De-escalation matters more than cleaning skill here. A defensive response is a red flag.',
      maxScore: 5,
    },
    {
      category: 'Honesty',
      q: "Have you ever accidentally broken or damaged something at a client's property? What did you do?",
      why: 'Everyone has. Looking for honesty and maturity, not perfection.',
      maxScore: 5,
    },
    {
      category: 'Availability',
      q: 'What days and hours are you available, and is that consistent week to week? Do you have your own transport?',
      why: 'Reliability and logistics. A cleaning round only works if someone turns up consistently.',
      maxScore: 5,
    },
    {
      category: 'Compliance',
      q: 'Are you happy to provide a right to work document before your start date and consent to a basic DBS check?',
      why: 'Legal requirement. Any hesitation is a significant red flag — this is non-negotiable.',
      maxScore: 5,
    },
  ],
  lead: [
    {
      category: 'Leadership',
      q: 'Tell me about a time you had to give someone constructive feedback. How did you approach it?',
      why: 'Team leads need to give feedback regularly. Looking for directness without aggression.',
      maxScore: 5,
    },
    {
      category: 'Problem-solving',
      q: 'If one of your team called in sick an hour before a job, what would you do?',
      why: "Operational thinking under pressure. There's no single right answer — looking for decisiveness.",
      maxScore: 5,
    },
    {
      category: 'Standards',
      q: "How would you spot if a team member's quality was slipping, and what would you do about it?",
      why: 'Proactive quality management is the main value of a team lead.',
      maxScore: 5,
    },
    {
      category: 'Clients',
      q: 'A client calls you directly to complain about a team member. How do you handle it?',
      why: 'Tests loyalty to both client and staff. A good answer balances both fairly.',
      maxScore: 5,
    },
    {
      category: 'Reliability',
      q: 'What does dependability mean to you as a team lead?',
      why: 'Open question. Reveals whether they understand the responsibility of a supervisory role.',
      maxScore: 5,
    },
    {
      category: 'Compliance',
      q: 'Are you happy to provide a right to work document and consent to an enhanced DBS check?',
      why: 'Team leads may handle keys, have greater client access — enhanced DBS is appropriate.',
      maxScore: 5,
    },
  ],
};
...
const CHECKLIST_ITEMS = [
  {
    id: 'rtw',
    label: 'Right to Work check — document sighted and copied',
    tier: 'required',
    detail:
      'Must see and copy original document (passport, BRP, or share code verification). Keep a copy on file. Legal requirement — failure is a criminal offence.',
  },
  {
    id: 'contract',
    label: 'Written statement of particulars signed',
    tier: 'required',
    detail:
      'Legally required from day one since April 2020. Must include: employer name, job title, start date, pay rate, working hours, holiday entitlement, notice period.',
  },
  {
    id: 'paye',
    label: 'Added to PAYE payroll — HMRC starter checklist complete',
    tier: 'required',
    detail:
      "Register as an employer with HMRC if you haven't already. Complete a starter checklist (P46 equivalent) for each new employee before their first pay date.",
  },
  {
    id: 'ni',
    label: 'National Insurance number collected and recorded',
    tier: 'required',
    detail:
      "Required for payroll submissions. If the employee doesn't have one, they must apply to HMRC. You can still pay them while they wait, but you need it on file.",
  },
  {
    id: 'insurance',
    label: 'Employer liability insurance policy updated',
    tier: 'required',
    detail:
      "You must have employer liability insurance as soon as you have an employee. Minimum £5m cover. Update your policy to include the new hire's name and role.",
  },
  {
    id: 'pension',
    label: 'Auto-enrolment pension eligibility assessed',
    tier: 'recommended',
    detail:
      "If they're over 22 and earning over £10,000/yr (even across multiple jobs), you must auto-enrol them in a workplace pension. NEST is the free government option.",
  },
  {
    id: 'dbs',
    label: 'Basic DBS check applied for',
    tier: 'recommended',
    detail:
      'Not legally required for domestic cleaning, but strongly recommended. Clients will ask. Apply via the DBS Update Service — £18 for basic check.',
  },
  {
    id: 'emergency',
    label: 'Emergency contact details collected',
    tier: 'recommended',
    detail: 'Name, relationship, phone number. Essential for lone working situations.',
  },
  {
    id: 'bankDetails',
    label: 'Bank details collected for payroll',
    tier: 'recommended',
    detail: 'Sort code and account number. Store securely.',
  },
  {
    id: 'uniform',
    label: 'Uniform or PPE kit issued and logged',
    tier: 'optional',
    detail:
      'Log what was issued and when. Useful for disputes about return of equipment on leaving.',
  },
  {
    id: 'keys',
    label: 'Key / access fob issued and logged',
    tier: 'optional',
    detail: 'Record which client keys they hold. Essential for security and liability.',
  },
  {
    id: 'photo',
    label: 'Photo for team dashboard uploaded',
    tier: 'optional',
    detail: 'Makes the team dashboard more personal and easier to use on mobile.',
  },
];
...
function Chip({ children, color = 'gray' }) {
  ...
  return (
    <span
      className={`inline-flex items-center px-2 py-0.5 rounded-sm text-xs font-bold border ${s[color] || s.gray}`}
    >
      {children}
    </span>
  );
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-gray-200 border border-gray-200 rounded-sm overflow-hidden">
        {[
          ...
          { label: 'Total hrs/wk', value: `${totalHours}hrs`, accent: 'text-brand-navy' },
          {
            label: 'Onboarding',
            value: onboarding,
            accent: onboarding > 0 ? 'text-amber-600' : 'text-brand-navy',
          },
          ...
          return (
            ...
            >
              <div className="flex items-start gap-3">
                {/* Avatar */}
                <div
                  className={`w-11 h-11 rounded-full flex items-center justify-center text-sm font-bold shrink-0 ${p.avatarBg}`}
                >
                  {p.avatar}
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    <span
                      className={`w-2 h-2 rounded-full shrink-0 ${STATUS_STYLE[p.status] || 'bg-gray-300'}`}
                    />
                  </div>
                  <p className="text-xs text-gray-400 mb-1">
                    {p.roleLabel} · {STATUS_LABEL[p.status]}
                  </p>
              ...
              <div className="mt-3 grid grid-cols-2 gap-2">
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <p
                      className={`text-xs font-bold ${oPct === 100 ? 'text-emerald-600' : oPct >= 50 ? 'text-amber-600' : 'text-red-500'}`}
                    >
                      {oPct}%
                    </p>
                  </div>
                  <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      className={`h-full rounded-full ${oPct === 100 ? 'bg-emerald-500' : oPct >= 50 ? 'bg-amber-400' : 'bg-red-400'}`}
                      style={{ width: `${oPct}%` }}
                    />
                  </div>
                </div>
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <p
                      className={`text-xs font-bold ${tPct === 100 ? 'text-emerald-600' : tPct >= 50 ? 'text-amber-600' : 'text-gray-400'}`}
                    >
                      {tPct}%
                    </p>
                  </div>
                  <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      className={`h-full rounded-full ${tPct === 100 ? 'bg-emerald-500' : tPct >= 50 ? 'bg-amber-400' : 'bg-gray-200'}`}
                      style={{ width: `${tPct}%` }}
                    />
                  </div>
                </div>
...
function OnboardingSection({ person, onUpdate }) {
  ...
  const tierConfig = {
    required: {
      label: 'Legally required — must complete before first day',
    ...
    optional: {
      label: 'Optional but good practice',
    ...
    <div className="space-y-4">
      ...
      <Card className="overflow-hidden">
        <div className="flex items-center gap-5 p-5 bg-brand-navy text-white">
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-widests text-brand-skyblue mb-1">
            ...
            <p className="text-xs text-brand-skyblue/70 mt-0.5">
              {pct === 100
                ? 'Fully onboarded — all checks complete'
                : `${total - completed} item${total - completed !== 1 ? 's' : ''} still needed`}
            </p>
          </div>
        </div>
      </Card>
                ...
                return (
                  <div key={item.id} className={`${cfg.bg}`}>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p
                          className={`text-sm font-semibold ${done ? 'line-through text-gray-400' : 'text-gray-800'}`}
                        >
                          {item.label}
                        </p>
                        {expanded && (
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        {done ? (
                          ...
                          <span className={`text-xs font-bold px-2 py-0.5 rounded-sm ${cfg.badge}`}>
                            {tier === 'required'
                              ? 'Required'
                              : tier === 'recommended'
                                ? 'Due'
      ...
      <Alert type="blue">
        <strong>Written statement of particulars:</strong> Cadi generates a compliant template
        pre-filled with {person.name}'s details. Print, sign, and give them a copy on day one. This
        is a legal right since April 2020 — not optional.
        <br />
        <br />
        <strong>Right to Work:</strong> You must see and keep a copy of the original document, not
        just note that you saw it. Cadi stores an encrypted copy here when you photograph it.
      </Alert>
    </div>
  );
}
...
// ─── SECTION: Interview ───────────────────────────────────────────────────────
function InterviewSection({ person }) {
  ...
  const handleLetter = async (type) => {
    ...
    try {
      const text = await generateLetter(
        type,
      ...
      setLetterText('Could not generate letter. Please try again.');
    }
  ...
  return (
    <div className="space-y-4">
      ...
      {Object.keys(scores).length > 0 && (
        <Card
          className={`overflow-hidden border-t-2 ${pct >= threshold ? 'border-t-emerald-500' : pct >= 40 ? 'border-t-amber-400' : 'border-t-red-500'}`}
        >
          <div className="px-5 py-4">
            <SL className="mb-1">Interview score</SL>
            <div className="flex items-baseline gap-3">
              <p
                className={`text-4xl font-bold tabular-nums ${pct >= threshold ? 'text-emerald-600' : pct >= 40 ? 'text-amber-600' : 'text-red-500'}`}
              >
                {pct}%
              </p>
              <p className="text-sm text-gray-400">
                {total} of {maxTotal} points · threshold {threshold}%
              </p>
            </div>
            <div className="h-2 bg-gray-100 rounded-full overflow-hidden mt-3">
              <div
                className={`h-full rounded-full ${pct >= threshold ? 'bg-emerald-500' : pct >= 40 ? 'bg-amber-400' : 'bg-red-400'}`}
                style={{ width: `${pct}%` }}
              />
            </div>
            <p className="text-xs text-gray-400 mt-2">
              {pct >= threshold
                ? 'Above threshold — proceed with reference check'
                : pct >= 40
                  ? 'Below recommended threshold — proceed with caution'
                  : 'Significantly below threshold — not recommended'}
            </p>
          </div>
        </Card>
      )}
        ...
        <div className="divide-y divide-gray-100">
          {questions.map((q, i) => (
            <div key={i} className="px-4 py-4">
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-brand-navy/10 text-brand-navy flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">
                  {i + 1}
                </div>
                <div className="flex-1">
                  <p className="text-xs font-bold tracking-widests uppercase text-gray-400 mb-1">
                    {q.category}
                  </p>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {[1, 2, 3, 4, 5].map((n) => (
                      <button
                        key={n}
                        onClick={() => setScores((prev) => ({ ...prev, [i]: n }))}
                    ...
                    {scores[i] && (
                      <span
                        className={`text-xs font-bold ml-2 ${scores[i] <= 2 ? 'text-red-500' : scores[i] === 3 ? 'text-amber-600' : 'text-emerald-600'}`}
                      >
                        {scores[i] <= 2
                          ? 'Concern'
                          : scores[i] === 3
      ...
      <Card className="overflow-hidden">
        <div className="px-4 py-3 border-b border-gray-100">
          <SL>Generate letter</SL>
        </div>
        <div className="p-4 space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-bold tracking-widests uppercase text-gray-400 mb-1">
                Candidate name
              </label>
              <input
                type="text"
          ...
          <div className="flex gap-2">
            <button
              onClick={() => handleLetter('offer')}
              className="flex-1 py-2.5 bg-brand-navy text-white text-xs font-bold uppercase tracking-wide hover:bg-brand-blue transition-colors rounded-sm"
            >
              Generate offer letter
            </button>
            <button
              onClick={() => handleLetter('reject')}
              className="flex-1 py-2.5 border border-gray-200 text-gray-600 text-xs font-bold uppercase tracking-wide hover:border-gray-400 transition-colors rounded-sm"
            >
              Generate rejection
            </button>
          </div>
            ...
            <div className="border border-gray-200 rounded-sm overflow-hidden">
              <div className="flex items-center justify-between px-4 py-2.5 bg-gray-50 border-b border-gray-200">
                <p className="text-xs font-bold text-gray-600">
                  {letterType === 'offer' ? 'Offer letter' : 'Rejection letter'}
                </p>
                <button
                  onClick={copyLetter}
                  className={`px-3 py-1 text-xs font-bold border rounded-sm transition-colors ${copied ? 'bg-emerald-50 text-emerald-700 border-emerald-200' : 'bg-white text-gray-600 border-gray-200 hover:border-brand-blue hover:text-brand-blue'}`}
                >
                  {copied ? 'Copied' : 'Copy'}
                </button>
              </div>
              <pre className="p-4 text-xs text-gray-700 leading-relaxed whitespace-pre-wrap font-sans">
                {letterText}
              </pre>
            </div>
          )}
          <Alert type="blue">
            Offer letters generated here are templates, not legally reviewed contracts. For a fully
            compliant written statement, use the ACAS template or consult an employment solicitor
...
function TrainingSection({ person, onUpdate }) {
  ...
  const generateAIPlan = async () => {
    ...
    try {
      ...
      setAiError('Could not generate plan. Check your connection and try again.');
    }
    setAiLoading(false);
  };
  ...
  const FEEDBACK_SCRIPTS = {
    '30day': {
      title: '30-day review',
      opener:
        "You've been with us for 30 days now and I wanted to take 20 minutes to check in properly.",
      questions: [
      ...
      toDocument:
        'Rate on quality (1–5), reliability (1–5), client feedback. Note any areas for development. Sign and date.',
    },
    '60day': {
      title: '60-day review',
      ...
      toDocument:
        'Quality score, reliability score, any issues addressed. Note 90-day goals agreed together. Sign and date.',
    },
    '90day': {
      title: '90-day review',
      opener:
        "Ninety days is a real milestone — you now know the business as well as anyone. Let's talk properly.",
      questions: [
      ...
      toDocument:
        'Full performance summary. Pay review consideration. Any change to hours, role, or responsibility. Both sign and date.',
    },
    difficult: {
      title: 'Difficult conversation guide',
      opener:
        "I wanted to have a quick chat — nothing to worry about, but there's something I'd like to address while it's still small.",
      questions: [
      ...
      toDocument:
        'Log the date, what was discussed, what was agreed, and any follow-up date. If the issue continues, this record becomes the basis of a formal PIP.',
    },
  };
    ...
    <div className="space-y-4">
      ...
      <Card className="overflow-hidden">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-gray-100">
          {Object.entries(TRAINING_TEMPLATES).map(([id, t]) => (
            ...
            >
              <p
                className={`text-xs font-bold mb-0.5 ${person.training.templateId === id ? 'text-white' : 'text-gray-800'}`}
              >
                {t.label.split(' — ')[0]}
              </p>
              <p
                className={`text-xs leading-tight ${person.training.templateId === id ? 'text-brand-skyblue' : 'text-gray-400'}`}
              >
                {t.desc}
              </p>
            </button>
      ...
      <Card className="overflow-hidden">
        ...
        <div className="p-4 space-y-3">
          <div>
            <label className="block text-xs font-bold tracking-widests uppercase text-gray-400 mb-1">
              Describe the role and any specific requirements
            </label>
            <textarea
              value={aiPrompt}
            ...
            return (
              <div key={week.id}>
                ...
                >
                  {/* Status dot */}
                  <div
                    className={`w-3 h-3 rounded-full shrink-0 ${weekDone ? 'bg-emerald-500' : weekStart ? 'bg-amber-400' : 'bg-gray-200'}`}
                  />
                  <div className="flex-1">
                    <p
                      className={`text-sm font-semibold ${weekDone ? 'text-emerald-700' : 'text-gray-800'}`}
                    >
                      {week.title}
                    </p>
                    <p className="text-xs text-gray-400 mt-0.5">
                      {week.tasks.filter((_, i) => completions[`${week.id}-${i}`]).length} of{' '}
                    ...
                    <div className="space-y-1.5 mb-3">
                      {week.tasks.map((task, ti) => {
                        ...
                        return (
                          <button
                            key={ti}
                            onClick={() => toggleTask(week.id, ti)}
                            className="w-full flex items-center gap-2.5 text-left"
                          >
                            <div
                              className={`w-4 h-4 rounded border flex items-center justify-center shrink-0 transition-colors ${done ? 'bg-emerald-500 border-emerald-500 text-white' : 'border-gray-300 hover:border-brand-blue'}`}
                            >
                              {done && (
                                <span
                            ...
                            <span
                              className={`text-sm ${done ? 'line-through text-gray-400' : 'text-gray-700'}`}
                            >
                              {task}
                            </span>
                          </button>
            ...
            <div className="space-y-2">
              {feedbackScript.questions.map((q, i) => (
                <div key={i} className="flex items-start gap-3 text-sm">
                  <div className="w-5 h-5 rounded-full bg-brand-skyblue/20 text-brand-navy flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">
                    {i + 1}
                  </div>
...
function PaySection({ person, onUpdate, onStaffUpdate, allStaff }) {
  ...
  const annualTax = Math.min(taxable, 37700) * 0.2 + Math.max(0, taxable - 37700) * 0.4;
  ...
  return (
    <div className="space-y-4">
      {/* Rate hero */}
      <Card
        className={`overflow-hidden border-t-2 ${rateChanged ? 'border-t-emerald-500' : 'border-t-brand-navy'}`}
      >
        <div className="p-5">
          <SL className="mb-2">Current pay rate</SL>
          <p className="text-4xl font-bold tabular-nums text-brand-navy">
            {fmt2(person.hourlyRate)}/hr
          </p>
          <p className="text-sm text-gray-400 mt-1">
            {fmt(gross)}/month estimated · {person.hoursPerWeek}hrs/wk
          </p>
          {rateChanged && (
            <p className="text-xs text-emerald-600 font-semibold mt-1">
              Rate updated — synced to Pricing, Business Lab and Money tab
            </p>
          )}
        </div>
      </Card>
      ...
      <Card className="overflow-hidden">
        ...
        <div className="divide-y divide-gray-100">
          {[
            ...
            {
              label: 'Income tax',
              value: `-${fmt2(annualTax / 12)}`,
              accent: 'text-red-500',
              bold: false,
              hint: `~${Math.round((annualTax / annualGross) * 100)}% effective rate`,
            },
            {
              label: 'Employee NI',
              value: `-${fmt2(annualNI / 12)}`,
              accent: 'text-red-500',
              bold: false,
            },
            ...(annualGross >= 10000
            ...
            <div
              key={label}
              className={`flex justify-between items-center px-4 py-3 ${bold ? 'bg-gray-50' : ''}`}
            >
              <div>
                <p className={`text-sm ${bold ? 'font-bold text-gray-800' : 'text-gray-500'}`}>
                  {label}
                </p>
        ...
        <div className="px-4 py-3 bg-brand-navy/5 border-t border-brand-navy/10">
          <p className="text-xs text-gray-500">
            Your cost: <span className="font-bold text-red-500">{fmt2(gross + empNI)}/mo</span>{' '}
            (gross + employer NI {fmt2(empNI)})
          </p>
          <p className="text-xs text-gray-400 mt-1">
            RTI submission due on or before pay date — use HMRC Basic PAYE Tools (free)
          </p>
        </div>
      </Card>
        ...
        <div className="p-4">
            ...
            {[
              {
                ...
                value: `${person.holidayEntitlement} days`,
                accent: 'text-brand-navy',
              },
              {
                label: 'Days taken',
                value: `${person.holidayTaken} days`,
                accent: 'text-amber-600',
              },
              {
                label: 'Days remaining',
                value: `${holidayRemaining.toFixed(1)} days`,
                accent: holidayRemaining < 5 ? 'text-red-500' : 'text-emerald-600',
              },
            ].map(({ label, value, accent }) => (
          ...
          <div className="h-2 bg-gray-100 rounded-full overflow-hidden mb-2">
            <div
              ...
              style={{
                width: `${Math.min((person.holidayTaken / person.holidayEntitlement) * 100, 100)}%`,
              }}
            />
          </div>
          <p className="text-xs text-gray-400">
            5.6 weeks statutory entitlement · {person.hoursPerWeek}h/wk ={' '}
            {person.holidayEntitlement} days/yr · Holiday year resets on start date anniversary
          </p>
          <div className="mt-3 flex gap-2">
            <button
              onClick={() =>
                onUpdate({
                  ...person,
                  holidayTaken: Math.min(person.holidayTaken + 1, person.holidayEntitlement),
                })
              }
            ...
            <button
              onClick={() =>
                onUpdate({ ...person, holidayTaken: Math.max(person.holidayTaken - 1, 0) })
              }
      ...
      <Alert type="gold">
        Cadi calculates payslip figures but does not submit to HMRC directly. Submit RTI via{' '}
        <strong>HMRC Basic PAYE Tools</strong> (free) or your accountant. All figures are estimates
        — actual tax code and NI category may differ.
      </Alert>
    </div>
  );
}
    ...
    <div className="fixed inset-0 bg-brand-navy/60 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      <Card className="w-full max-w-md max-h-[95vh] flex flex-col sm:rounded-sm rounded-t-xl">
        <div className="flex items-center justify-between px-5 py-4 bg-brand-navy text-white shrink-0">
          ...
          <button
            onClick={onClose}
            className="text-brand-skyblue hover:text-white text-lg leading-none"
          >
            ✕
          </button>
        </div>
        <div className="overflow-y-auto flex-1 p-5 space-y-4">
          ...
          <div className="flex items-center gap-3 p-3 bg-gray-50 border border-gray-100 rounded-sm">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ${roleObj?.avatarBg || 'bg-gray-100 text-gray-500'}`}
            >
              {initials}
            </div>
            <div>
              ...
              <p className="text-xs text-gray-400">
                {roleObj?.label} · {fmt2(parseFloat(rate) || 0)}/hr · {hours}h/wk
              </p>
            </div>
          </div>
          ...
          {/* Role */}
          <div>
            <label className="block text-xs font-bold tracking-widests uppercase text-gray-400 mb-2">
              Role
            </label>
          ...
          {parseFloat(rate) < 12.21 && parseFloat(rate) > 0 && (
            <Alert type="warn">
              Rate is below the National Living Wage (£12.21/hr for 2026). Adjust before proceeding.
            </Alert>
          )}
        </div>
        <div className="px-5 py-4 border-t border-gray-100 bg-gray-50 flex gap-2 shrink-0">
          ...
          <button
            onClick={onClose}
            className="px-5 py-3 border border-gray-200 text-gray-500 text-xs font-bold uppercase hover:border-gray-300 rounded-sm transition-colors"
          >
            Cancel
          </button>
        </div>
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50/50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-start justify-between">
        <div>
          <p className="text-xs font-bold tracking-widests uppercase text-brand-blue mb-0.5">
            Cadi
          </p>
          <h2 className="text-2xl font-bold text-brand-navy">Staffing</h2>
          <p className="text-xs text-gray-400 mt-0.5">
            {staff.length} team member{staff.length !== 1 ? 's' : ''} ·{' '}
            {staff.filter((s) => s.status === 'onboarding').length} onboarding
          </p>
        </div>
        <button
        ...
        <div className="bg-white border-b border-gray-200 px-4 py-2 overflow-x-auto">
          <div className="flex gap-2 min-w-max">
            {staff.map((p) => (
              ...
              >
                <div
                  className={`w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold shrink-0 ${selectedId === p.id ? 'bg-white/20 text-white' : p.avatarBg}`}
                >
                  {p.avatar}
                </div>
          ...
          {SECTIONS.map((s) => (
            <button
              ...
              onClick={() => {
                ...
                if (s.id !== 'overview' && !selectedId && staff.length > 0)
      ...
      <div className="bg-white border-t border-gray-100 px-6 py-2.5 flex items-center justify-between">
        <p className="text-xs text-gray-400">
          UK employment law guidance only — not legal advice. Consult an employment solicitor for
          complex situations.
        </p>
        <button
