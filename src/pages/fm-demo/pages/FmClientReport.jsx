...
import { Shield, Copy, ExternalLink, CheckCircle2, AlertCircle, X } from 'lucide-react';
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              background: copied ? 'rgba(16,185,129,0.25)' : 'rgba(79,120,255,0.25)',
              border: `1px solid ${copied ? 'rgba(16,185,129,0.4)' : 'rgba(79,120,255,0.4)'}`,
            }}
          >
            <Copy size={13} />
        ...
        <div className="bg-white">
          ...
          <div className="grid grid-cols-4 border-b border-gray-100">
            {[
              ...
              },
              {
                ...
                value: `${site.sla}%`,
                sub: 'within time window',
                color: scoreColor,
              },
              {
                label: 'Avg. time on site',
                value: `${site.avgTime}m`,
                sub: 'per clean',
                color: '#059669',
              },
              {
                label: 'Evidence photos',
                value: site.photos.toLocaleString(),
                sub: 'geo-verified',
                color: '#7c3aed',
              },
          ...
          <div className="px-8 py-6">
            <h2 className="text-xs font-black uppercase tracking-widest text-gray-400 mb-4">
              Recent cleans — geo-verified evidence
            </h2>
            <div className="space-y-2">
              {site.recentCleans.map((clean, i) => (
                <div
                  key={i}
                  className="flex items-center gap-4 px-4 py-3 rounded-xl border border-gray-100 bg-gray-50"
                >
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    {clean.sla ? (
                      <span
                        className="flex items-center gap-1 text-[10px] font-black text-emerald-700 px-2 py-0.5 rounded-full"
                        style={{
                      ...
                      <span
                        className="flex items-center gap-1 text-[10px] font-black text-amber-700 px-2 py-0.5 rounded-full"
                        style={{
                  ...
                  <div className="ml-auto text-xs font-black text-gray-700 shrink-0">
                    £{clean.value}
                  </div>
                </div>
              ))}
          ...
          >
            ...
            <div>
              <div className="text-sm font-black text-emerald-800">
                All evidence is geo-verified and tamper-evident
              </div>
              <div className="text-xs text-emerald-700 mt-1 leading-relaxed">
                Every photo carries GPS coordinates (±4–7m accuracy), a precise timestamp, and a
                SHA-256 audit hash recorded at upload. Britannia Group guarantees that all evidence
                shown here was captured on-site within the agreed SLA window.
              </div>
            </div>
          </div>
          ...
          <div className="px-8 pb-6 border-t border-gray-100 pt-6">
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-xl bg-amber-50 border border-amber-200 flex items-center justify-center text-sm font-black text-amber-700">
                  {site.issues.raised}
                </div>
                <div className="text-xs text-gray-600">Issues raised</div>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-xl bg-emerald-50 border border-emerald-200 flex items-center justify-center text-sm font-black text-emerald-700">
          ...
          <div className="px-8 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
            ...
            <div className="text-[10px] text-gray-400">
              Confidential — for {site.client} use only
            </div>
          </div>
        </div>
      </div>
...
const IMPACT = [
  {
    before: 'Monthly PDF report built manually, sent by email',
    after: 'Live client portal — they see it before you send anything',
    icon: '📊',
  },
  {
    before: 'Clients dispute SLA claims with no proof',
    after: 'Geo-verified evidence behind every visit — undisputable',
    icon: '🔒',
  },
  {
    before: 'Compliance packs take half a day to compile',
    after: 'Exportable with one click — always up to date',
    icon: '⚡',
  },
];

export default function FmClientReport({ showToast: _showToast }) {
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="text-white/40 text-sm mt-0.5">
            Live site-by-site compliance — shareable with clients instantly
          </div>
        </div>
        <button
          ...
          style={{
            ...
            boxShadow: '0 4px 24px rgba(79,120,255,0.35)',
          }}
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="text-sm font-black" style={{ color: sc }}>
                  {site.score}%
                </div>
      ...
      <div className="grid grid-cols-[1fr_280px] gap-5">
          ...
          <GlassCard className="p-6">
            <div className="flex items-center gap-6">
              ...
              <div className="text-right shrink-0">
                <div className="text-white/35 text-[10px] font-black uppercase tracking-widest mb-1">
                  Client
                </div>
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-white/40 text-xs mt-0.5">
                  Cadi score: <span className="text-emerald-400 font-bold">{s.cleaner.score}</span>
                </div>
              </div>
            </div>
          ...
          <button
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(79,120,255,0.25), rgba(79,120,255,0.15))',
              border: '1px solid rgba(79,120,255,0.4)',
            }}
            onMouseEnter={(e) =>
              (e.currentTarget.style.background =
                'linear-gradient(135deg, rgba(79,120,255,0.4), rgba(79,120,255,0.25))')
            }
            onMouseLeave={(e) =>
              (e.currentTarget.style.background =
                'linear-gradient(135deg, rgba(79,120,255,0.25), rgba(79,120,255,0.15))')
            }
          >
            ...
            <div className="text-white/40 text-[10px] mt-1 font-normal">
              What {s.client.split(' ')[0]} sees in their portal
            </div>
          </button>
        </div>
      </div>
