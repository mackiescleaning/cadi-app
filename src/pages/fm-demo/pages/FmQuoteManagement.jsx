...
import { CheckCircle2, Clock, MessageSquare, Zap, ChevronRight, Plus, X } from 'lucide-react';
...
const CADI_ESTIMATES = {
  'Window cleaning': {
    label: 'Est. £90–155 per job',
    note: '47 comparable window cleans avg £122 per visit.',
  },
  'Jet washing': {
    label: 'Est. £180–280 per job',
    note: '23 comparable jet wash jobs avg £238 per visit.',
  },
  'Gutter clearing': {
    label: 'Est. £150–420 per job',
    note: '14 comparable gutter clears avg £290 per visit.',
  },
  'Graffiti removal': {
    label: 'Est. £380–520 per job',
    note: '9 comparable graffiti removals avg £440 per visit.',
  },
};
...
const INITIAL_CARDS = [
  {
    id: 'jc0',
    contractor: 'Premier Exterior Ltd',
    site: 'Asda – Luton Supercentre',
    ...
    lineItems: [],
    cadi: {
      label: 'Est. £120–145 per job',
      note: '12 comparable superstore window cleans avg £132. Standard two-storey exterior.',
    },
  },
  {
    id: 'jc2',
    contractor: 'Capital Gutters Ltd',
    ...
    sent: '20 May',
    cadi: {
      label: 'Est. £350–420 per job',
      note: "6 similar L&D Hospital tower clears — contractor's quote of £380 is within expected range.",
    },
    lineItems: [
  ...
  {
    id: 'jc4',
    contractor: 'SprayTech Services',
    site: 'Premier Inn Bedford',
    ...
    lineItems: [],
    cadi: {
      label: '£460–520 specialist range',
      note: 'Graffiti removal carries a specialist premium. SprayTech typically prices £470–490 per job — consider revising up slightly.',
    },
  },
  {
    id: 'jc3',
    contractor: 'ProWash Midlands',
    site: 'Amazon Tilbury – Exterior',
    service: 'Jet washing',
    date: 'Fri 29 May',
    time: '06:30–10:30',
    status: 'awaiting',
    ...
    lineItems: [],
    cadi: {
      label: '£220–260 per job',
      note: 'Distribution centre jet wash avg £238 per job. Your price is competitive.',
    },
  },
  {
    id: 'jc5',
    contractor: 'Apex Window Care',
    site: 'Watling House Offices',
    service: 'Window cleaning',
    date: 'Thu 4 Jun',
    time: '06:00–09:00',
    status: 'negotiating',
    ...
    sent: '18 May',
    cadi: {
      label: 'Est. £180–210 per job',
      note: '4-floor comparable office avg £195. Contractor quoted £210 — your counter of £190 is reasonable.',
    },
    lineItems: [
  ...
  {
    id: 'jc1',
    contractor: 'Clearview Window Services',
    site: 'Tesco Distribution – Welwyn',
    service: 'Window cleaning',
    date: 'Sat 30 May',
    time: '07:00–09:00',
    status: 'accepted',
    ...
    lineItems: [],
    cadi: {
      label: '£130–155 per job',
      note: '47 comparable Tesco window cleans avg £142 per visit — your price was in range.',
    },
  },
];
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div
          style={{ fontSize: 10, color: 'rgba(255,255,255,0.35)', marginTop: 2, lineHeight: 1.5 }}
        >
          {note}
        </div>
      </div>
            ...
            <div key={n} style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              {n > 1 && (
                <div
                  style={{
                    width: 28,
                    height: 1,
                    background: step >= n ? '#38bdf8' : 'rgba(255,255,255,0.12)',
                  }}
                />
              )}
              <div
              ...
              <span
                style={{
                  fontSize: 11,
                  fontWeight: 800,
                  color: step === n ? '#38bdf8' : 'rgba(255,255,255,0.3)',
                }}
              >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                ...
                {SERVICES_LIST.map((s) => (
                  <button
                    ...
                    style={{
                      ...
                      background:
                        service === s ? 'rgba(56,189,248,0.15)' : 'rgba(255,255,255,0.04)',
            ...
            {service && (
              <div>
                ...
                >
                  ...
                  >
                    — ranked by rating for {service.toLowerCase()}
                  </span>
                </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                          <span style={{ fontSize: 10, color: '#fbbf24', fontWeight: 800 }}>
                            ★ {c.rating}
                          </span>
              ...
              <div>
                ...
                <select
                  ...
                  style={{
                    ...
                    color: site ? 'white' : 'rgba(255,255,255,0.3)',
                    fontSize: 12,
                    fontWeight: 600,
                    outline: 'none',
                    cursor: 'pointer',
            ...
            <button
              ...
              style={{
                ...
                fontSize: 13,
                fontWeight: 900,
                cursor: canStep1 ? 'pointer' : 'default',
        ...
        {step === 2 && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            >
              ...
              <br />
              Contractor:{' '}
              <span style={{ color: '#38bdf8', fontWeight: 800 }}>{contractor?.name}</span>
              {contractor && (
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                {[
                  { id: 'set', label: "I'll set the price" },
                  { id: 'quote', label: 'Request their quote' },
                ].map((m) => (
                  <button
                    key={m.id}
                    ...
                    style={{
                      ...
                      transition: 'all 0.12s',
                      background:
                        mode === m.id ? 'rgba(56,189,248,0.12)' : 'rgba(255,255,255,0.04)',
...
function CardDetail({ card, onBack, onUpdateCard, showToast }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <div
        style={{ borderRadius: 16, overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)' }}
      >
        <div
          style={{
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)', marginTop: 2 }}>
              {card.site} · {card.service}
            </div>
            <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.25)', marginTop: 2 }}>
              {card.date} · {card.time}
              {card.sent ? ` · Sent ${card.sent}` : ''}
            </div>
          </div>
              ...
              <tbody>
                {card.lineItems.map((item, i) => (
                  <tr
                    ...
                    style={{
                      borderBottom:
                        i < card.lineItems.length - 1 ? '1px solid rgba(255,255,255,0.04)' : 'none',
                    }}
                  >
                    <td
                      style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <button
            onClick={() => {
              ...
              showToast(`Price £${priceInput} sent to ${card.contractor}`);
            }}
            disabled={!priceInput}
            style={{
              width: '100%',
              ...
              fontSize: 13,
              fontWeight: 900,
              background: priceInput
                ? 'linear-gradient(135deg, #0ea5e9, #0284c7)'
                : 'rgba(255,255,255,0.06)',
              color: priceInput ? 'white' : 'rgba(255,255,255,0.2)',
              border: 'none',
              cursor: priceInput ? 'pointer' : 'default',
              boxShadow: priceInput ? '0 4px 16px rgba(14,165,233,0.3)' : 'none',
              transition: 'all 0.15s',
            }}
          >
          ...
          <button
            onClick={() => {
              ...
              showToast(`Quote requested from ${card.contractor}`);
            }}
            style={{
              background: 'none',
              border: 'none',
        ...
        >
          ...
          <div>
            <div style={{ fontSize: 12, fontWeight: 800, color: '#fbbf24' }}>
              {card.mode === 'quote'
                ? 'Quote requested — awaiting contractor response'
                : 'Price sent — awaiting contractor response'}
            </div>
      ...
      {card.status === 'declined' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          >
            <div style={{ fontSize: 12, fontWeight: 800, color: '#f87171', marginBottom: 3 }}>
              Contractor declined — re-offer at a higher price
            </div>
            <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>
              {card.contractor} declined your price of {card.price}. Enter a revised price to
              re-offer.
            </div>
          </div>
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            <div style={{ flex: 1, position: 'relative' }}>
              ...
              <input
                ...
                placeholder="Revised job price"
                type="number"
                value={reofferInput}
                onChange={(e) => setReofferInput(e.target.value)}
              />
            </div>
            <button
              onClick={() => {
                if (!reofferInput) return;
                onUpdateCard(card.id, {
                  status: 'awaiting',
                  price: `£${reofferInput}`,
                  sent: '27 May',
                });
                showToast(`Revised price £${reofferInput} sent to ${card.contractor}`);
              }}
              disabled={!reofferInput}
              style={{
                padding: '0.65rem 1.1rem',
                borderRadius: 10,
                background: reofferInput
                  ? 'linear-gradient(135deg, #ea580c, #c2410c)'
                  : 'rgba(255,255,255,0.06)',
                border: 'none',
                color: reofferInput ? 'white' : 'rgba(255,255,255,0.25)',
                fontWeight: 900,
                fontSize: 12,
                cursor: reofferInput ? 'pointer' : 'default',
                flexShrink: 0,
              }}
            >
              Re-offer →
      ...
      {card.status === 'quote-received' && (
        <div style={{ display: 'flex', gap: 8 }}>
          <button
            onClick={() => {
              onUpdateCard(card.id, { status: 'accepted' });
              showToast(`Quote from ${card.contractor} approved at ${card.price}`);
            }}
            style={{
              flex: 1,
              padding: '0.75rem',
          ...
          <button
            onClick={() => {
              showToast(`Counter-offer sent to ${card.contractor}`);
              onBack();
            }}
            style={{
              flex: 1,
          ...
          <button
            onClick={() => {
              showToast(`Quote from ${card.contractor} declined`);
              onBack();
            }}
            style={{
      ...
      {card.status === 'negotiating' && (
        ...
        >
          <div style={{ fontSize: 12, fontWeight: 800, color: '#fb923c', marginBottom: 3 }}>
            Counter-offer sent — awaiting contractor response
          </div>
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>
            Your counter of {card.counterOffer} sent to {card.contractor}. They will accept,
            counter, or decline in-app.
          </div>
        </div>
      )}
        ...
        >
          ...
          <div>
            <div style={{ fontSize: 12, fontWeight: 800, color: '#34d399' }}>
              Job confirmed at {card.price}
            </div>
            <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', marginTop: 2 }}>
              Invoice will land in your accounts inbox on completion.
            </div>
          </div>
        </div>
      )}
...
export default function FmQuoteManagement({ showToast }) {
  ...
  const awaiting = cards.filter(
    (c) => c.status === 'awaiting' || c.status === 'negotiating'
  ).length;
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 14, fontWeight: 900, color: 'white', marginBottom: 3 }}>
                Create, price &amp; deploy
              </div>
              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)', lineHeight: 1.5 }}>
                Pick a service · choose your contractor · set a price with Cadi's benchmark · deploy
                in one click
              </div>
            </div>
          </div>
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  borderLeft: i > 0 ? '1px solid rgba(14,165,233,0.1)' : 'none',
                  display: 'flex',
                  alignItems: 'center',
                  gap: 8,
                }}
                      ...
                      <>
                        <div
                          style={{
                            fontSize: 17,
                            fontWeight: 900,
                            color: card.mode === 'quote' ? '#a78bfa' : '#38bdf8',
                          }}
                        >
                          {card.price}
                        </div>
                        <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.25)' }}>
                          {card.status === 'quote-received' || card.status === 'negotiating'
                            ? 'quoted'
                            : 'per job'}
                        </div>
                      </>
