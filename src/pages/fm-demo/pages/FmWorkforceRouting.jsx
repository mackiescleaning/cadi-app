    ...
    <div className="p-6 max-w-5xl space-y-5">
      ...
      >
        ...
        >
          {[
            {
              before: 'Workforce coverage tracked in a spreadsheet updated manually',
              after: 'Coverage gaps flagged automatically — act before a shift is missed',
              icon: '👥',
            },
            {
              before: 'Deciding employed vs contractor by instinct',
              after: 'Cadi recommends the right routing per area — compliance built in',
              icon: '⚖️',
            },
            {
              before: 'Cover arranged by phone when someone drops out',
              after: 'Connect fills gaps in under 15 minutes — no FM involvement needed',
              icon: '🔄',
            },
        ...
        {[
          {
            v: `${coveragePct}%`,
            l: 'Coverage',
            c: coveragePct === 100 ? '#34d399' : coveragePct > 70 ? '#fbbf24' : '#f87171',
          },
      ...
      >
        <div
          className="grid px-5 py-2.5 text-[10px] font-black uppercase tracking-widest text-white/25"
          style={{
        ...
        >
          ...
          <span className="text-center w-52">Route</span>
        </div>
      ...
      {/* Staff capacity */}
      <div>
        <div className="text-[10px] font-black uppercase tracking-widest text-white/25 mb-3 px-1">
          Employed staff capacity
        </div>
      ...
      {unassigned.length > 0 && (
        ...
        >
          ...
          <span className="text-xs text-white/50">
            {unassigned.length} area{unassigned.length !== 1 ? 's' : ''} still unassigned — assign
            to Employed or Connect before generating job cards.
          </span>
        </div>
      )}
