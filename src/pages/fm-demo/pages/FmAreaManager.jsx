...
const VISIT_SCHEDULE = [
  {
    time: '08:30',
    site: 'L&D Hospital — Main Tower',
    purpose: 'Quality audit — Main Tower wards',
    status: 'due',
    addr: 'Lewsey Rd, Luton LU4 0DZ',
    contact: 'Geoff Hartley (Facilities)',
  },
  {
    time: '10:45',
    site: 'HSBC Birmingham',
    purpose: 'Issue follow-up — 3 open complaints',
    status: 'overdue',
    addr: '3 Broad St, Birmingham B1 2HF',
    contact: 'Karen Moss (Building Mgr)',
  },
  {
    time: '13:00',
    site: 'Premier Inn Luton Airport',
    purpose: 'Routine inspection + staff check-in',
    status: 'due',
    addr: 'Spittlesea Rd, Luton LU2 9NZ',
    contact: 'Dan Greer (Hotel Ops)',
  },
];
...
const STAFF_FLAGS = [
  {
    ...
    name: 'Claire Nduka',
    id: 'E-0234',
    detail: 'Return-to-work interview required on return — 3rd absence in 90 days',
    site: 'L&D Hospital',
    urgency: 'high',
  },
  {
    ...
    name: 'Marcus Webb',
    id: 'E-0311',
    detail: 'Scheduled 6-month performance review — overdue by 12 days',
    site: 'Town Hall',
    urgency: 'medium',
  },
  {
    ...
    name: 'Jordan Price',
    id: 'E-0521',
    detail: 'New starter — site induction sign-off pending (started 26 May)',
    site: 'Aldi Dunstable',
    urgency: 'high',
  },
  {
    ...
    name: 'Tom Griffiths',
    id: 'E-0089',
    detail: 'Informal warning issued 14 May — 28-day review period active',
    site: 'HSBC Bham',
    urgency: 'medium',
  },
  {
    ...
    name: 'Leah Okonkwo',
    id: 'E-0398',
    detail: 'Healthcare infection control training expires 1 Jun — not yet renewed',
    site: 'L&D Hospital',
    urgency: 'high',
  },
];
...
const CLIENT_LOG = [
  {
    ...
    openIssues: [
      {
        date: '18 May',
        desc: 'Boardroom glass not cleaned — noticed by HSBC director',
        status: 'open',
      },
      {
        date: '20 May',
        desc: 'Cleaning operative arrived 25 min late — no SMS notification',
        status: 'open',
      },
      {
        date: '22 May',
        desc: 'Mop bucket left in corridor — trip hazard flagged',
        status: 'actioned',
      },
    ],
    lastAudit: 82,
  ...
  },
  {
    ...
    openIssues: [
      {
        date: '21 May',
        desc: 'Room 214 — toilet not cleaned before 09:00 check-in',
        status: 'open',
      },
...
const STAFF_MESSAGES = [
  {
    ...
    site: 'Asda Luton',
    time: 'Mon 08:34',
    text: 'Ward 4B all done and signed off.',
    read: true,
  },
  {
    name: 'Jordan Price',
    ...
    site: 'Aldi RDC',
    time: 'Tue 06:45',
    text: 'Morning — is my induction sign-off happening today?',
    read: false,
  },
  {
    name: 'Tom Griffiths',
    ...
    site: 'HSBC Bham',
    time: 'Tue 15:20',
    text: "Hi James, can we speak about my warning when you're at HSBC?",
    read: false,
  },
];
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-white/35 text-xs">
          Wednesday 27 May 2026 · Your patch — 6 sites · 30 staff
        </p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-3">
        {[
          ...
          {
            label: 'Hours shortfall',
            value: `${hoursShortfall}h`,
            color: '#34d399',
            alert: hoursShortfall < -10,
          },
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: '0.7rem', fontWeight: 800, color: 'white' }}>
                {ab.name}{' '}
                <span style={{ color: 'rgba(255,255,255,0.3)', fontWeight: 500 }}>{ab.id}</span>
              </div>
              <div style={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.4)', marginTop: 1 }}>
                {ab.site} · {ab.shift} · {ab.reason}
              </div>
            </div>
            {ab.cover ? (
              <span
              ...
              <button
                onClick={() => {
                  setCovered((c) => ({ ...c, [ab.name]: true }));
                  showToast(`Cover arranged for ${ab.name}`);
                }}
                style={{
                  flexShrink: 0,
          ...
          return (
            <div
              ...
              style={{
                ...
                padding: '0.5rem 1rem',
                borderBottom:
                  i < HOURS_DATA.length - 1 ? '1px solid rgba(255,255,255,0.04)' : 'none',
              }}
            >
              <span
                style={{
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: 9999,
                    width: `${barPct}%`,
                    background: bad ? '#f87171' : ok ? '#34d399' : '#fbbf24',
                  }}
                />
              </div>
              <span
                style={{
                  ...
                  minWidth: 60,
                  textAlign: 'right',
                  color: bad ? '#f87171' : ok ? 'rgba(255,255,255,0.6)' : '#fbbf24',
                }}
              >
              ...
              <span
                style={{
                  ...
                  minWidth: 36,
                  textAlign: 'right',
                  color: bad ? '#f87171' : over ? '#34d399' : 'rgba(255,255,255,0.3)',
                }}
              >
            ...
            >
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: '0.58rem', color: 'rgba(255,255,255,0.35)', marginTop: 1 }}>
                  {site.client} · {site.staff} staff · Next visit:{' '}
                  <span
                    style={{
                      color: overdue ? '#f87171' : 'rgba(255,255,255,0.5)',
                      fontWeight: 700,
                    }}
                  >
                    {site.nextVisit}
              ...
              <div style={{ display: 'flex', gap: '0.4rem', flexShrink: 0, alignItems: 'center' }}>
                <span
                  style={{
                    ...
                    borderRadius: '999px',
                    background: slaOk ? 'rgba(52,211,153,0.1)' : 'rgba(251,191,36,0.1)',
                    color: slaOk ? '#34d399' : '#fbbf24',
                    border: `1px solid ${slaOk ? 'rgba(52,211,153,0.25)' : 'rgba(251,191,36,0.25)'}`,
                  }}
                >
                  {site.sla}% SLA
                </span>
                <span
                  style={{
                    ...
                    padding: '0.2rem 0.5rem',
                    borderRadius: '999px',
                    background: auditOk ? 'rgba(79,120,255,0.1)' : 'rgba(248,113,113,0.1)',
                    color: auditOk ? '#818cf8' : '#f87171',
                    border: `1px solid ${auditOk ? 'rgba(79,120,255,0.25)' : 'rgba(248,113,113,0.25)'}`,
                  }}
                >
          ...
          return (
            <div
              ...
              style={{
                ...
                borderBottom:
                  i < STAFF_MESSAGES.length - 1 ? '1px solid rgba(255,255,255,0.04)' : 'none',
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: '0.57rem', color: 'rgba(255,255,255,0.25)', marginTop: 2 }}>
                  {msg.time}
                </div>
              </div>
              {!isRead && (
              ...
              {isRead && (
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    showToast(`Replying to ${msg.name}`);
                  }}
                  style={{
                    flexShrink: 0,
...
function RoundTab({ showToast }) {
  ...
  const AUDIT_ITEMS = [
    'Floors — swept, mopped, dry',
    'Toilets — clean, stocked, odour-free',
    'Reception/common areas',
    'Waste removal completed',
    'Operative in uniform + ID badge',
    'COSHH products stored correctly',
          ...
          >
            ...
            >
              <div
                style={{
                  ...
                  fontSize: '0.7rem',
                  fontWeight: 900,
                  color: done ? '#34d399' : isOverdue ? '#f87171' : '#818cf8',
                }}
              >
                {done ? '✓' : v.time}
              </div>
              ...
              <div style={{ display: 'flex', gap: '0.4rem', flexShrink: 0 }}>
                ...
                {done ? (
                  ...
                  <button
                    onClick={() => setAuditOpen(isOpen ? null : v.site)}
                    style={{
            ...
            {isOpen && !done && (
              ...
              >
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            setScores((s) => ({
                              ...s,
                              [v.site]: { ...siteScores, [item]: e.target.checked },
                            }))
                          }
                        ...
                        <span
                          style={{
                            fontSize: '0.65rem',
                            color: checked ? 'rgba(255,255,255,0.7)' : 'rgba(255,255,255,0.45)',
                          }}
                        >
                          {item}
                        </span>
                ...
                <button
                  onClick={() => {
                    setVisited((vis) => ({ ...vis, [v.site]: true }));
                    setAuditOpen(null);
                    showToast(`Audit logged for ${v.site}`);
                  }}
                  style={{
                    width: '100%',
                    padding: '0.6rem',
    ...
    <div className="space-y-5">
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: '0.7rem', fontWeight: 800, color: 'white' }}>
            Holiday Requests — pending approval
          </span>
          <span
            style={{
              marginLeft: 'auto',
          ...
          return (
            <div
              ...
              style={{
                ...
                padding: '0.62rem 1rem',
                borderBottom:
                  i < HOLIDAY_REQUESTS.length - 1 ? '1px solid rgba(255,255,255,0.04)' : 'none',
            ...
            >
              ...
              {isDone ? (
                ...
                <div style={{ display: 'flex', gap: '0.35rem', flexShrink: 0 }}>
                  <button
                    onClick={() => {
                      setApproved((a) => new Set([...a, i]));
                      showToast(`Holiday approved for ${req.name}`);
                    }}
                    style={{
                  ...
                  <button
                    onClick={() => {
                      setDeclined((d) => new Set([...d, i]));
                      showToast(`Holiday declined for ${req.name}`);
                    }}
                    style={{
                      padding: '0.28rem 0.65rem',
                      borderRadius: '0.35rem',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.65rem' }}>
        {[
          ...
          {
            label: 'High urgency',
            value: STAFF_FLAGS.filter((f) => f.urgency === 'high').length,
            color: '#f87171',
          },
          {
            label: 'RTW due',
            value: STAFF_FLAGS.filter((f) => f.type === 'rtw').length,
            color: '#fbbf24',
          },
          {
            label: 'Training expiry',
            value: STAFF_FLAGS.filter((f) => f.type === 'training').length,
            color: '#a78bfa',
          },
          ...
          return (
            <div
              ...
              style={{
                ...
                padding: '0.7rem 1rem',
                borderBottom:
                  i < STAFF_FLAGS.length - 1 ? '1px solid rgba(255,255,255,0.04)' : 'none',
                opacity: done ? 0.5 : 1,
              }}
            >
              <div
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div
                  style={{ fontSize: '0.62rem', color: 'rgba(255,255,255,0.45)', lineHeight: 1.4 }}
                >
                  {flag.detail}
                </div>
                <div style={{ fontSize: '0.58rem', color: 'rgba(255,255,255,0.25)', marginTop: 2 }}>
                  {flag.site}
                </div>
              </div>
              {done ? (
                <span
                  style={{ flexShrink: 0, fontSize: '0.62rem', fontWeight: 800, color: '#34d399' }}
                >
                  ✓ Done
                </span>
              ) : (
                <button
                  onClick={() => {
                    setActioned((a) => new Set([...a, i]));
                    showToast(`${flag.name} — ${cfg.label} actioned`);
                  }}
                  style={{
                    flexShrink: 0,
                    padding: '0.3rem 0.7rem',
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-white/35 text-xs">
          Open issues, contact history and scheduled reviews per site
        </p>
      </div>
      ...
      {CLIENT_LOG.map((cl) => {
        ...
        return (
          ...
          >
            {/* Row header */}
            <button
              onClick={() => setExpandedSite(isOpen ? null : cl.site)}
              style={{
                width: '100%',
                display: 'flex',
                alignItems: 'center',
            ...
            >
              <div style={{ flex: 1, minWidth: 0 }}>
                <div
                  style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: 2 }}
                >
                ...
                <div style={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.35)' }}>
                  Contact: {cl.client} · Last contact: {cl.lastContact} · Next review:{' '}
                  {cl.nextReview}
                </div>
              </div>
              <div style={{ display: 'flex', gap: '0.4rem', flexShrink: 0, alignItems: 'center' }}>
                ...
                <span
                  style={{
                    ...
                    fontWeight: 800,
                    color:
                      cl.lastAudit >= 95 ? '#34d399' : cl.lastAudit >= 90 ? '#fbbf24' : '#f87171',
                  }}
                >
                  {cl.lastAudit} audit
                </span>
            ...
            {isOpen && (
              ...
              >
                      ...
                      >
                        ...
                        <span
                          style={{
                            ...
                            fontSize: '0.58rem',
                            fontWeight: 800,
                            color: issue.status === 'open' ? '#fb923c' : '#34d399',
                          }}
                        >
                ...
                <div style={{ display: 'flex', gap: '0.4rem' }}>
                  <button
                    onClick={() => showToast(`Calling ${cl.client}`)}
                    style={{
                      flex: 1,
                      padding: '0.45rem',
                      borderRadius: '0.4rem',
                  ...
                  <button
                    onClick={() => showToast(`Issue logged for ${cl.site}`)}
                    style={{
                      flex: 1,
                      padding: '0.45rem',
                      borderRadius: '0.4rem',
                  ...
                  <button
                    onClick={() => showToast(`Preparing visit report for ${cl.site}`)}
                    style={{
                      flex: 1,
                      padding: '0.45rem',
                      borderRadius: '0.4rem',
