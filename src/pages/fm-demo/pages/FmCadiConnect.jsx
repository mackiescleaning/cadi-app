...
const WEEK_JOBS = [
  ...
  // Cadi Connect jobs (FM subcontract)
  {
    ...
    start: 6,
    dur: 2,
    label: 'Premier Inn Luton Airport',
    type: 'connect',
    source: 'connect',
    fm: 'Britannia Group',
    ref: '#BF-4471',
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: '0.72rem', color: '#6b7280', lineHeight: 1.4 }}>
            In the full build, Cadi Connect jobs sync directly into your main Cadi scheduler — one
            calendar, everything in view. Conflicts and gaps flagged automatically.
          </div>
        </div>
        <div style={{ display: 'flex', gap: '0.5rem', flexShrink: 0 }}>
          ...
          >
            <div style={{ fontWeight: 900, fontSize: '0.95rem', color: '#C2410C' }}>
              {connectCount}
            </div>
          ...
          >
            <div style={{ fontWeight: 900, fontSize: '0.95rem', color: '#010a4f' }}>
              £{connectValue}
            </div>
            <div style={{ fontSize: '0.62rem', color: '#6b7280', fontWeight: 600 }}>
              Connect val
        ...
        (() => {
          ...
          return (
            ...
            >
              ...
              />
              <div>
                <div style={{ fontWeight: 800, fontSize: '0.82rem', color: '#010a4f' }}>
                  {j.label}
                </div>
                <div style={{ fontSize: '0.72rem', color: '#64748b' }}>
                  {String(j.start).padStart(2, '0')}:00 – {String(j.start + j.dur).padStart(2, '0')}
                  :00
                  {j.fm && ` · ${j.fm}`}
                  {j.ref && ` · ${j.ref}`}
                </div>
  ...
  return (
    <div className="p-6 space-y-4 max-w-5xl">
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(167,139,250,0.1), rgba(79,120,255,0.08))',
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-1.5 font-black text-sm">
              <CadiWordmark height={16} /> <span className="text-white">Connect Network</span>
            </div>
            <div className="text-white/45 text-xs mt-0.5">
              Verified operatives available to Britannia Group — all scored, background-checked,
              ready to deploy.
            </div>
          </div>
          <div className="ml-auto grid grid-cols-3 gap-4 text-center">
            <div>
              <div className="font-black text-lg" style={{ color: '#a78bfa' }}>
                {eliteCount}
              </div>
              <div className="text-[10px] text-white/30">Elite</div>
            </div>
            <div>
              <div className="font-black text-lg" style={{ color: '#34d399' }}>
                {verifiedCount}
              </div>
              <div className="text-[10px] text-white/30">Verified</div>
            </div>
            <div>
              <div className="font-black text-lg" style={{ color: '#4f78ff' }}>
                {avgScore}
              </div>
            ...
            >
              <div className="flex items-start gap-3">
                <div
                  ...
                  style={{
                    background:
                      'linear-gradient(135deg, rgba(79,120,255,0.4), rgba(99,102,241,0.3))',
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-white/35 text-[10px] mt-0.5">
                    {c.town} · {c.distance} mi away
                  </div>
                  <div className="flex gap-1 mt-2 flex-wrap">
                    {c.services.slice(0, 2).map((s) => (
                      <span
                        key={s}
                        className="text-[9px] px-1.5 py-0.5 rounded text-white/45"
                        style={{
                          background: 'rgba(255,255,255,0.06)',
                    ...
                    {c.services.length > 2 && (
                      <span
                        className="text-[9px] px-1.5 py-0.5 rounded text-white/25"
                ...
                <div className="ml-auto">
                  <button
                    onClick={() => {
                      ...
                      showToast(`request ${c.name} for Britannia Group`);
                    }}
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.875rem' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.45)', lineHeight: 1.5 }}>
              Your contractor pool handles your current contracts — but when a bigger tender needs
              cover across 3 regions on short notice, that's where Cadi Connect turns a maybe into a
              yes.
            </div>
          </div>
        </div>
        ...
        {[
          {
            ...
            color: '#a78bfa',
            n: '1,200+',
            label: 'vetted operatives on the network',
            sub: 'All DBS-checked, scored, insured',
          },
          {
            icon: ZapIcon,
            color: '#fb923c',
            n: '24 hrs',
            label: 'average time to fill a gap',
            sub: 'vs 2+ days of phone calls',
          },
          {
            icon: TrendingUp,
            color: '#34d399',
            ...
            sub: 'Pay per job dispatched, nothing upfront',
          },
          ...
          >
            ...
            <div style={{ fontWeight: 900, fontSize: '1.2rem', color: 'white', lineHeight: 1 }}>
              {n}
            </div>
            <div
              style={{
              ...
              >
                <div
                  style={{
                    ...
                    height: 20,
                    borderRadius: '50%',
                    background: i === 2 ? 'rgba(22,163,74,0.2)' : 'rgba(255,255,255,0.07)',
                    border: `1px solid ${i === 2 ? 'rgba(22,163,74,0.4)' : 'rgba(255,255,255,0.1)'}`,
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    fontSize: '0.55rem',
                    fontWeight: 900,
                    color: i === 2 ? '#4ade80' : 'rgba(255,255,255,0.35)',
                    flexShrink: 0,
                  }}
                >
                  {s.n}
                ...
                <div
                  style={{
                    fontSize: '0.52rem',
                    color: i === 2 ? '#4ade80' : 'rgba(255,255,255,0.38)',
                    fontWeight: 700,
                    textAlign: 'center',
                    lineHeight: 1.3,
                    whiteSpace: 'pre-line',
