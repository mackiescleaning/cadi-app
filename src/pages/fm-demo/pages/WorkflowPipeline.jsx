...
const EXTERIOR_STEPS = [
  ...
  { id: 'jobcards', label: 'Job Cards',   pages: ['ext-quotes', 'ext-deploy'], firstPage: 'ext-quotes'     },
...
export default function WorkflowPipeline({ mode, page, onNavigate }) {
  ...
  const accentGrad  = mode === 'contract'
            ...
            <div key={step.id} style={{ display: 'flex', alignItems: 'center' }}>
              <button
                ...
                style={{
                  ...
                  border: isActive ? `1px solid ${mode === 'contract' ? 'rgba(234,88,12,0.3)' : 'rgba(22,163,74,0.3)'}` : '1px solid transparent',
              ...
              >
                ...
                <div style={{
                  ...
                  background: isComplete ? accentGrad : isActive ? accentGrad : 'rgba(0,0,0,0.08)',
                ...
                {/* Label */}
                <span style={{
                  fontSize: 11, fontWeight: isActive ? 800 : isComplete ? 700 : 500,
              ...
              {/* Connector */}
              {idx < steps.length - 1 && (
                <ChevronRight size={13} style={{ color: 'rgba(0,0,0,0.15)', flexShrink: 0, margin: '0 2px' }} />
              )}
            </div>
          );
        })}
