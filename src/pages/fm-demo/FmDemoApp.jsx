    ...
    items: [
      {
        ...
        tooltip:
          'Live across all sites — jobs today, staff on-site, cover rate and payroll in one view. The "under one roof" anchor.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        component: FmTupe,
        tooltip:
          'Track staff transfers when winning a contract — 30-day consultation windows, DBS checks and document compliance, all in one view.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        component: FmClientPortals,
        tooltip:
          'Every client portal in one place. Open, configure and manage access for each client.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: 'Import Staff',
        icon: Users,
        component: FmStaffImport,
        tooltip:
          'Bulk upload your 1,487 PAYE employees via CSV — Cadi creates Staff App accounts and sends SMS invites automatically.',
      },
      {
        id: 'hr-staff',
        label: 'Staff & HR',
        ...
        component: FmStaffHR,
        tooltip:
          '1,487 employed staff · DBS, right-to-work, training and payroll compliance all in one place.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: 'Area Manager',
        icon: Radio,
        component: FmAreaManager,
        tooltip:
          'Morning briefing, site round audits, staff actions and client relationship log — everything an area manager needs in one view.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: 'Staff Rota',
        icon: Calendar,
        component: FmStaffRota,
        tooltip:
          'Cleaners see their schedule in the app. Rotas built and published — no WhatsApp, no spreadsheets.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        component: FmLiveOps,
        tooltip:
          "Check-in status across every site in real time. Know who's on site before the client notices.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        component: FmSubPool,
        tooltip:
          'Import your existing contractors via CSV — Cadi sends app invites automatically. Your pool is live in minutes.',
      },
      {
        id: 'cadi-connect',
        label: 'Cadi Connect',
        icon: Globe,
        component: FmCadiConnect,
        tooltip:
          'Browse the wider network of vetted, scored contractors — tap in when your own pool is at capacity.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        component: FmClients,
        tooltip:
          'Client enquiry comes in — log the contact, confirm sites and set up the exterior contract.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: 'Job Cards',
        icon: TrendingUp,
        component: FmQuoteManagement,
        tooltip:
          "Create a job card, set your price with Cadi's suggestion, then deploy to a contractor — all in one place.",
      },
      {
        id: 'ext-deploy',
        label: 'Job Cards',
        icon: Wand2,
        component: FmDeployExterior,
        hidden: true,
        tooltip:
          'One card per job type per location. Each card goes straight to a verified contractor.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: 'Scheduling',
        icon: Calendar,
        component: FmExteriorScheduling,
        tooltip:
          'Contractor picks their date and time in the app. Job card updates and Britannia Group is notified.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: 'Live Jobs',
        icon: MapPin,
        component: FmExteriorLive,
        tooltip:
          'Contractor marks job complete and uploads photo evidence. Saved to the job — no chasing.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: Receipt,
        component: FmAccounts,
        badge: 2,
        tooltip:
          'Submitted invoices land here. Approve, query or reject — then pay or export to Xero.',
      },
    ],
  },
];
...
function DemoCompleteModal({ onClose, visitedExternal, onOpenPortal }) {
  const PORTALS = [
    ...
    },
    {
      key: 'client',
      label: 'Client Portal',
      sub: "Asda's live view",
      done: visitedExternal.client,
      color: '#34d399',
      emoji: '🏪',
      url: '/client-demo',
    },
    {
      key: 'staff',
      label: 'Staff App',
      sub: "Sarah's cleaner view",
      done: visitedExternal.staff,
      color: '#4f78ff',
      emoji: '🧹',
      url: '/staff-demo',
    },
    {
      ...
      sub: 'Contractor view',
      done: visitedExternal.contractor,
      color: '#a78bfa',
      emoji: '🔧',
      url: '/operative-demo',
    },
  ...
  const NEXT_STEPS = [
    {
      ...
      sub: 'Tailored to your contracts and sites',
      color: '#ea580c',
      cta: 'Book now →',
      href: 'mailto:hello@cadi.cleaning?subject=Live%20Walkthrough%20Request',
    },
    {
      emoji: '🚀',
      label: 'Start a pilot',
      sub: 'Live on one contract in 2 weeks',
      color: '#34d399',
      cta: 'Get started →',
      href: 'https://cadi.cleaning',
    },
    {
      emoji: '💷',
      label: 'Get pricing',
      sub: 'Per-site, no hidden fees',
      color: '#a78bfa',
      cta: 'See pricing →',
      href: 'https://cadi.cleaning',
    },
    {
      ...
      sub: 'Send the link to your team',
      color: '#38bdf8',
      cta: 'Copy link →',
      onClick: () => {
    ...
    >
      <div
        style={{
          ...
          boxShadow: '0 40px 100px rgba(0,0,0,0.75), 0 0 80px rgba(234,88,12,0.07)',
          animation: 'popup-in 0.28s cubic-bezier(0.34,1.56,0.64,1)',
        }}
      >
        {/* Header */}
        <div
        ...
        <div style={{ padding: '18px 28px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            {PORTALS.map((p) => (
              <div
                ...
                style={{
                  ...
                  alignItems: 'center',
                  gap: 10,
                  cursor: !p.done && p.url ? 'pointer' : 'default',
                  transition: 'all 0.15s',
                  background: p.done ? `${p.color}0e` : 'rgba(255,255,255,0.03)',
                  border: p.done ? `1px solid ${p.color}35` : '1px solid rgba(255,255,255,0.07)',
                }}
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div
                    style={{
                      fontSize: 12,
                      fontWeight: 800,
                      color: p.done ? 'white' : 'rgba(255,255,255,0.3)',
                    }}
                  >
                    {p.label}
                  </div>
                ...
                <div
                  style={{
                    ...
                    fontSize: 10,
                    fontWeight: 900,
                    background: p.done ? p.color : 'rgba(255,255,255,0.07)',
                    color: p.done ? 'white' : 'rgba(255,255,255,0.25)',
                  }}
                >
                  {p.done ? '✓' : '↗'}
                </div>
          ...
          {!allSeen && (
            ...
            >
              Click an unvisited portal above to open it in a new tab — it updates the checklist
              automatically.
            </div>
          )}
        </div>
          ...
          >
            {NEXT_STEPS.map((item) => (
              ...
              >
                ...
                <div style={{ fontSize: 12, fontWeight: 900, color: 'white', marginBottom: 3 }}>
                  {item.label}
                </div>
                <div
                  style={{
          ...
          >
            <div>
              <div style={{ fontSize: 12, fontWeight: 800, color: 'white' }}>
                Talk to the Cadi team
              </div>
              <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.35)', marginTop: 2 }}>
                hello@cadi.cleaning · cadi.cleaning
              </div>
            </div>
            <a
              href="https://cadi.cleaning"
              target="_blank"
              rel="noreferrer"
              style={{ fontSize: 11, fontWeight: 800, color: '#ea580c', textDecoration: 'none' }}
            >
              cadi.cleaning →
            </a>
          </div>
    ...
    >
      ...
      >
        <div>
          ...
          >
            ~20 MIN · 10 STEPS · CONTRACT PATH FIRST
          </div>
        </div>
        <button
          onClick={onClose}
      ...
      >
        <button
          ...
          onMouseEnter={(e) =>
            (e.currentTarget.style.background =
              'linear-gradient(135deg,rgba(234,88,12,0.28),rgba(194,65,12,0.2))')
          }
          onMouseLeave={(e) =>
            (e.currentTarget.style.background =
              'linear-gradient(135deg,rgba(234,88,12,0.18),rgba(194,65,12,0.12))')
          }
        >
        ...
        >
          Tip: click any step to jump there instantly. ↗ steps open in a new tab — keep this portal
          open behind them.
        </div>
      </div>
    </div>
...
function NavTooltip({ label, text, y }) {
  const top = Math.max(
    12,
    Math.min(typeof window !== 'undefined' ? window.innerHeight - 110 : 600, y - 38)
  );
  return (
    <div
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: 12,
          padding: '10px 14px',
          boxShadow: '0 8px 32px rgba(234,88,12,0.1), 0 2px 12px rgba(0,0,0,0.08)',
        }}
      >
        <div
        ...
        <div className="text-[11px] leading-snug" style={{ color: '#4b4540' }}>
          {text}
        </div>
      </div>
    </div>
...
export default function FmDemoApp() {
  ...
  const [visitedExternal, setVisitedExternal] = useState(() => ({
    client:
      typeof localStorage !== 'undefined' && localStorage.getItem('cadi_visited_client') === '1',
    staff:
      typeof localStorage !== 'undefined' && localStorage.getItem('cadi_visited_staff') === '1',
    contractor:
      typeof localStorage !== 'undefined' &&
      localStorage.getItem('cadi_visited_contractor') === '1',
  }));
  ...
  function handleExternalVisit(url) {
    ...
    const updates = {};
    if (url.includes('client-demo')) {
      localStorage.setItem('cadi_visited_client', '1');
      updates.client = true;
    }
    if (url.includes('staff-demo')) {
      localStorage.setItem('cadi_visited_staff', '1');
      updates.staff = true;
    }
    if (url.includes('operative-demo')) {
      localStorage.setItem('cadi_visited_contractor', '1');
      updates.contractor = true;
    }
  ...
  function handleOpenPortal(url, key) {
    window.open(url, '_blank');
    const storageKey = {
      client: 'cadi_visited_client',
      staff: 'cadi_visited_staff',
      contractor: 'cadi_visited_contractor',
    }[key];
    if (storageKey) {
      localStorage.setItem(storageKey, '1');
      setVisitedExternal((prev) => ({ ...prev, [key]: true }));
    }
  }
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          fontFamily: "'Satoshi', 'Inter', sans-serif",
          background: 'linear-gradient(145deg, #0f0d0a 0%, #1c1510 35%, #0f0c09 65%, #171209 100%)',
        }}
      >
        {/* Ambient blobs */}
        <div className="fixed inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 0 }}>
          <div
            style={{
              ...
              height: '60%',
              borderRadius: '50%',
              background: `radial-gradient(circle, ${mode === 'exterior' ? 'rgba(22,163,74,0.14)' : 'rgba(234,88,12,0.16)'} 0%, transparent 70%)`,
          ...
          <div
            style={{
              ...
              height: '50%',
              borderRadius: '50%',
              background: `radial-gradient(circle, ${mode === 'exterior' ? 'rgba(34,197,94,0.09)' : 'rgba(251,191,36,0.1)'} 0%, transparent 70%)`,
          ...
          <div
            style={{
              position: 'absolute',
              inset: 0,
              backgroundImage: `linear-gradient(${mode === 'exterior' ? 'rgba(22,163,74,0.022)' : 'rgba(234,88,12,0.025)'} 1px, transparent 1px), linear-gradient(90deg, ${mode === 'exterior' ? 'rgba(22,163,74,0.022)' : 'rgba(234,88,12,0.025)'} 1px, transparent 1px)`,
        ...
        <div className="fixed top-0 right-0 z-50 pointer-events-none overflow-hidden w-20 h-20">
          <div
            className="text-white text-[9px] font-black tracking-widest py-1.5 text-center"
            style={{
        ...
        {guideOpen && (
          <DemoGuidePanel
            currentPage={page}
            onNavigateWithMode={navigateWithMode}
        ...
        {showDemoComplete && (
          <DemoCompleteModal
            ...
            visitedExternal={visitedExternal}
        ...
        <aside
          ...
          style={{
            ...
            borderRight: `1px solid ${mode === 'exterior' ? 'rgba(22,163,74,0.15)' : 'rgba(234,88,12,0.15)'}`,
            boxShadow: `2px 0 24px ${mode === 'exterior' ? 'rgba(22,163,74,0.06)' : 'rgba(234,88,12,0.07)'}`,
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              pointerEvents: 'none',
              background: `linear-gradient(180deg, ${mode === 'exterior' ? 'rgba(22,163,74,0.04)' : 'rgba(234,88,12,0.04)'} 0%, transparent 30%)`,
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <div className="text-[11px] leading-tight" style={{ color: 'rgba(0,0,0,0.35)' }}>
                  Ops Portal
                </div>
              </div>
            </div>
            <div className="flex items-center gap-1.5">
              <div
                ...
                style={{ background: '#ea580c', boxShadow: '0 0 4px rgba(234,88,12,0.8)' }}
              />
              <div
                className="text-[9px] font-black uppercase tracking-[0.2em]"
                style={{ color: 'rgba(0,0,0,0.25)' }}
              >
                Live · Powered by Cadi
              </div>
            </div>
          </div>
            ...
            <div className="px-3 pb-3">
              ...
              <div className="flex gap-1">
                {REGIONS.map((r) => (
                  <button
                    key={r}
                    onClick={() => setRegion(r.toLowerCase())}
          ...
          <nav className="flex-1 px-2.5 py-2 overflow-y-auto space-y-4">
            {navGroups.map(({ group, items }) => (
              <div key={group}>
                <div
                  className="px-3 mb-1 text-[9px] font-black uppercase tracking-[0.18em]"
                ...
                <div className="space-y-0.5">
                  {items
                    ...
                    .map(({ id, label, icon: Icon, badge, tooltip: tipText }) => {
                        ...
                        <button
                          ...
                          onMouseEnter={(e) => {
                            ...
                            if (tipText) {
                              ...
                              setTooltip({ label, text: tipText, y: r.top + r.height / 2 });
                            }
                          }}
                          onMouseLeave={(e) => {
                          ...
                          style={
                            active
                              ? {
                                  ...
                                  color: mode === 'exterior' ? '#14532d' : '#9a3412',
                                  boxShadow: `inset 0 1px 0 rgba(255,255,255,0.6)`,
                                }
                              : { color: 'rgba(0,0,0,0.48)', border: '1px solid transparent' }
                          }
                        >
                          {active && (
                            <div
                          ...
                          <Icon
                            size={15}
                            style={{ color: active ? accent : 'rgba(0,0,0,0.32)', flexShrink: 0 }}
                          />
                          <span
                            className="flex-1 text-left tracking-tight font-semibold"
                            style={
                              active
                                ? {
                                    color: mode === 'exterior' ? '#14532d' : '#9a3412',
          ...
          <div className="px-2.5 pb-2 relative" style={{ borderTop: '1px solid rgba(0,0,0,0.06)' }}>
            ...
            <div className="px-3 pb-3">
              <a
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = 'rgba(234,88,12,0.07)';
                  e.currentTarget.style.color = 'rgba(234,88,12,0.8)';
        ...
        >
          <header
            ...
            style={{
              borderBottom: `1px solid ${mode === 'exterior' ? 'rgba(22,163,74,0.1)' : 'rgba(234,88,12,0.1)'}`,
          ...
          >
            <a
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = 'rgba(234,88,12,0.14)';
                e.currentTarget.style.color = '#ea580c';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = 'rgba(234,88,12,0.07)';
                e.currentTarget.style.color = 'rgba(234,88,12,0.65)';
              }}
            >
              ← Demo home
            </a>
            <div className="flex items-center gap-3 flex-1">
              <h1 className="font-black text-base tracking-tight" style={{ color: '#1a1210' }}>
                {current.label}
              </h1>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div
                className="text-[9px] font-black px-3 py-1.5 rounded-full tracking-[0.15em]"
                style={{
                  color: '#ea580c',
          ...
          {page !== 'home' && <WorkflowPipeline mode={mode} page={page} onNavigate={setPage} />}
          ...
          <main className="flex-1 overflow-y-auto overflow-x-hidden">
            {page === 'home' ? (
              ...
              <ActivePage
                showToast={showToast}
                onNavigate={setPage}
                onNavigateMain={setPage}
                onNavigateWithMode={navigateWithMode}
                region={region}
                mode={mode}
                initialClientId={demoClientId}
                onSelectClient={setDemoClientId}
              />
            )}
          </main>
        </div>
