...
export function weatherChip(day) {
  ...
  return { emoji: weatherEmoji(day.condition), tempMaxC: day.tempMaxC, rainy, title: bits.filter(Boolean).join(' · ') };
}
...
export const CREW_PALETTE = ["#F97316", "#EA580C", "#10B981", "#059669", "#1F48FF", "#7C3AED", "#EC4899", "#0891B2"];
